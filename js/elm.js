...
var $author$project$Main$init = F3(
	function (flag, _v0, key) {
		...
		var initialModel = {
			...
			isMenuOpen: false,
			key: key,
			page: $author$project$Main$AccountsPage($author$project$Pages$Accounts$initialModel),
			primaryaddress: '',
		...
		switch (msg.$) {
			case 'AddNewCryptoAccount':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{cryptoAccountType: cryptoAcct, currentView: $author$project$Pages$Accounts$CryptoAccounts}),
					$elm$core$Platform$Cmd$none);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Accounts$AddNewCryptoAccount($author$project$Pages$Accounts$BTC))
			]));
};
...
var $author$project$Pages$Funds$xmrBalView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				model.isAddressVisible ? ('Available Balance: ' + ($author$project$Pages$Funds$xmrAvailableBalanceAsString(model.balances) + ' XMR')) : $author$project$Extras$Constants$blankAddress)
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Version 0.5.60')
									])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Utils$MyUtils$gotBalancesReplyAsTypeAlias(model.balances).available + ' XMR')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
