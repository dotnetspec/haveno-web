...
var $author$project$Pages$Blank$GotInitialModel = function (a) {
...
var $author$project$Pages$Blank$init = function (_v0) {
	return _Utils_Tuple2(
		_Utils_update(
			...
			{title: 'Haveno-Web'}),
		A2($elm$core$Platform$Cmd$map, $author$project$Pages$Blank$GotInitialModel, $elm$core$Platform$Cmd$none));
};
...
var $author$project$Pages$Dashboard$Model = F9(
	function (status, pagetitle, root, balances, primaryaddress, flagUrl, havenoAPKHttpRequest, version, errors) {
		return {balances: balances, errors: errors, flagUrl: flagUrl, havenoAPKHttpRequest: havenoAPKHttpRequest, pagetitle: pagetitle, primaryaddress: primaryaddress, root: root, status: status, version: version};
	});
			...
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Accounts$ManageAccountsView, primaryaddress: primaryAddresponse.primaryAddress, status: $author$project$Pages$Accounts$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'GotBalances':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{balances: response.balances, currentView: $author$project$Pages$Accounts$ManageAccountsView, status: $author$project$Pages$Accounts$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Pages$Dashboard$Errored = {$: 'Errored'};
var $author$project$Pages$Dashboard$update = F2(
	function (msg, model) {
		if (msg.$ === 'BalanceResponse') {
			if (msg.a.$ === 'Ok') {
				var response = msg.a.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{balances: response.balances, status: $author$project$Pages$Dashboard$Loaded}),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: $author$project$Pages$Dashboard$Errored}),
					$elm$core$Platform$Cmd$none);
			}
		} else {
			if (msg.a.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{primaryaddress: primaryAddresponse.primaryAddress, status: $author$project$Pages$Dashboard$Loaded}),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{primaryaddress: primaryAddresponse.primaryAddress}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Pages$Accounts$CryptocurrencyAccounts = {$: 'CryptocurrencyAccounts'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('traditionalCurrencyAccountsButton')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('cryptocurrencyAccountsButton')
					]),
				_List_fromArray(
					[
						A2(
						...
						$author$project$Pages$Accounts$ChangeView($author$project$Pages$Accounts$CryptocurrencyAccounts))
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('walletPasswordButton')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('walletSeedButton')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('backupButton')
					]),
				_List_fromArray(
					[
						A2(
