...
{
	if (region.v_.jB === region.V.jB)
	{
		return 'on line ' + region.v_.jB;
	}
	return 'on lines ' + region.v_.jB + ' through ' + region.V.jB;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var value = result.a;
		var message = !tag ? value : tag < 3 ? value.a : value.jU;
		var stopPropagation = tag == 1 ? value.b : tag == 3 && value.oe;
		var currentEventNode = (
			stopPropagation && event.stopPropagation(),
			(tag == 2 ? value.b : tag == 3 && value.n9) && event.preventDefault(),
			eventNode
		);
		var tagger;
		var i;
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var doc = view(model);
				var nextNode = _VirtualDom_node('body')(_List_Nil)(doc.sZ);
				var patches = _VirtualDom_diff(currNode, nextNode);
				bodyNode = _VirtualDom_applyPatches(bodyNode, currNode, patches, sendToApp);
				currNode = nextNode;
				_VirtualDom_divertHrefToApp = 0;
				(title !== doc.wo) && (_VirtualDom_doc.title = title = doc.wo);
			});
		}
	);
});
...
{
	var onUrlChange = impl.u4;
	var onUrlRequest = impl.u5;
	...
	return _Browser_document({
		...
		un: function(flags)
		{
			return A3(impl.un, flags, _Browser_getUrl(), key);
		},
		wy: impl.wy,
		wv: impl.wv,
		v5: impl.v5
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ub: 'hidden', s9: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ub: 'mozHidden', s9: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ub: 'msHidden', s9: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ub: 'webkitHidden', s9: 'webkitvisibilitychange' }
		: { ub: 'hidden', s9: 'visibilitychange' };
}
...
{
	var flags = 'g';
	if (options.uT) { flags += 'm'; }
	if (options.s6) { flags += 'i'; }
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.iG.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.iG.b, xhr)); });
		$elm$core$Maybe$isJust(request.wt) && _Http_track(router, xhr, request.wt.a);

		try {
			xhr.open(request.uN, request.bJ, true);
		} catch (e) {
		...
		request.sZ.a && xhr.setRequestHeader('Content-Type', request.sZ.a);
		xhr.send(request.sZ.b);
...
{
	for (var headers = request.t9; headers.b; headers = headers.b) // WHILE_CONS
	{
		xhr.setRequestHeader(headers.a.a, headers.a.b);
	}
	xhr.timeout = request.wn.a || 0;
	xhr.responseType = request.iG.d;
	xhr.withCredentials = request.sJ;
}
...
function _Http_toMetadata(xhr)
{
	return {
		...
		v$: xhr.status,
		v0: xhr.statusText,
		t9: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
...
function _Http_track(router, xhr, tracker)
{
	...
	xhr.addEventListener('progress', function(event) {
		...
		_Scheduler_rawSpawn(A2($elm$core$Platform$sendToSelf, router, _Utils_Tuple2(tracker, $elm$http$Http$Receiving({
			vr: event.loaded,
			vU: event.lengthComputable ? $elm$core$Maybe$Just(event.total) : $elm$core$Maybe$Nothing
		}))));
	});
}
...
var $elm$core$Array$builderToArray = F2(
	function (reverseNodeList, builder) {
		if (!builder.an) {
			...
			var treeLen = builder.an * $elm$core$Array$branchFactor;
			var depth = $elm$core$Basics$floor(
				A2($elm$core$Basics$logBase, $elm$core$Array$branchFactor, treeLen - 1));
			var correctNodeList = reverseNodeList ? $elm$core$List$reverse(builder.av) : builder.av;
			var tree = A2($elm$core$Array$treeFromBuilder, correctNodeList, builder.an);
			return A4(
				$elm$core$Array$Array_elm_builtin,
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{av: nodeList, an: (len / $elm$core$Array$branchFactor) | 0, au: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {tW: fragment, ft: host, f6: path, ky: port_, nk: protocol, vq: query};
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {i1: index, qh: match, X: number, v4: submatches};
	});
...
var $RomanErnst$erl$Erl$parse = function (str) {
	return {
		m7: $RomanErnst$erl$Erl$hasLeadingSlashFromAll(str),
		m8: $RomanErnst$erl$Erl$hasTrailingSlashFromAll(str),
		af: $RomanErnst$erl$Erl$hashFromAll(str),
		ft: $RomanErnst$erl$Erl$host(str),
		n6: '',
		f6: $RomanErnst$erl$Erl$pathFromAll(str),
		ky: $RomanErnst$erl$Erl$extractPort(str),
		nk: $RomanErnst$erl$Erl$extractProtocol(str),
		vq: $RomanErnst$erl$Erl$queryFromAll(str),
		a7: ''
	};
};
...
var $author$project$Pages$Dashboard$HavenoAPKHttpRequest = F6(
	function (method, headers, url, body, timeout, tracker) {
		return {sZ: body, t9: headers, uN: method, wn: timeout, wt: tracker, bJ: url};
	});
...
var $author$project$Pages$Dashboard$Model = F8(
	function (status, title, root, balance, flagUrl, havenoAPKHttpRequest, version, errors) {
		return {sS: balance, d1: errors, iL: flagUrl, pM: havenoAPKHttpRequest, rj: root, rP: status, wo: title, eB: version};
	});
...
var $author$project$Proto$Io$Haveno$Protobuffer$Internals_$defaultProto__Io__Haveno__Protobuffer__GetVersionReply = {eB: ''};
...
var $eriktim$elm_protocol_buffers$Internal$Int32$operations = {tX: $elm$core$Basics$identity, tY: $eriktim$elm_protocol_buffers$Internal$Int32$fromSigned, tZ: $eriktim$elm_protocol_buffers$Internal$Int32$fromZigZag, vj: $eriktim$elm_protocol_buffers$Internal$Int32$popBase128, vp: $eriktim$elm_protocol_buffers$Internal$Int32$pushBase128, wp: $eriktim$elm_protocol_buffers$Internal$Int32$toSigned, wq: $eriktim$elm_protocol_buffers$Internal$Int32$toZigZag};
	...
	function (width, state) {
		return (state.ds <= 0) ? ($elm$core$Set$isEmpty(state.kU) ? $elm$bytes$Bytes$Decode$succeed(
			...
			function (_v0) {
				...
				var wireType = _v1.b;
				var _v2 = A2($elm$core$Dict$get, fieldNumber, state.nL);
				if (!_v2.$) {
					var decoder = _v2.a;
					return A2(
						$elm$bytes$Bytes$Decode$map,
...
var $eriktim$elm_protocol_buffers$Protobuf$Encode$toVarIntEncoders = F2(
	function (config, value) {
		var _v0 = config.vj(value);
		var base128 = _v0.a;
		var higherBits = _v0.b;
		return _Utils_eq(
			higherBits,
			config.tX(0)) ? _List_fromArray(
			[
...
var $author$project$Proto$Io$Haveno$Protobuffer$GetVersion$getVersion = {tx: $author$project$Proto$Io$Haveno$Protobuffer$decodeGetVersionReply, tM: $author$project$Proto$Io$Haveno$Protobuffer$encodeGetVersionRequest, vd: 'io.haveno.protobuffer', vG: 'GetVersion', vR: 'GetVersion'};
...
var $anmolitor$elm_grpc$Grpc$new = F2(
	function (rpc, req) {
		return {
			...
			nm: false,
			k0: rpc,
			wn: $elm$core$Maybe$Nothing,
			wt: $elm$core$Maybe$Nothing
		};
	});
	...
	function (decoder, httpResponse) {
		var parseResponse = F3(
			function (isGoodStatus, metadata, bytes) {
				var defaultGrpcStatus = isGoodStatus ? 0 : $anmolitor$elm_grpc$Grpc$httpBadStatusToGrpcStatus(metadata.v$);
				var grpcStatus = A2(
					$elm$core$Maybe$withDefault,
					defaultGrpcStatus,
					A2(
						...
						A2(
							$elm$core$Maybe$andThen,
							$elm$core$String$toInt,
							A2($elm$core$Dict$get, 'grpc-status', metadata.t9))));
				if (!grpcStatus) {
					return A2(
						...
						A2(
							$elm$core$Maybe$andThen,
							function (response) {
								return A2($eriktim$elm_protocol_buffers$Protobuf$Decode$decode, decoder, response.jU);
							},
					...
					var errMessage = A2(
						$elm$core$Maybe$withDefault,
						metadata.v0,
						A2($elm$core$Dict$get, 'grpc-message', metadata.t9));
					return $elm$core$Result$Err(
						$anmolitor$elm_grpc$Grpc$BadStatus(
							{tN: errMessage, cE: metadata, vz: bytes, rP: grpcStatus}));
				}
			});
		switch (httpResponse.$) {
			case 4:
...
var $elm$http$Http$onEffects = F4(
	function (router, cmds, subs, state) {
		return A2(
			...
			A3($elm$http$Http$updateReqs, router, cmds, state.re));
	});
			...
			return $elm$http$Http$Request(
				{
					sJ: r.sJ,
					sZ: r.sZ,
					iG: A2(_Http_mapExpect, func, r.iG),
					t9: r.t9,
					uN: r.uN,
					wn: r.wn,
					wt: r.wt,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{sJ: false, sZ: r.sZ, iG: r.iG, t9: r.t9, uN: r.uN, wn: r.wn, wt: r.wt, bJ: r.bJ}));
};
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{sJ: true, sZ: r.sZ, iG: r.iG, t9: r.t9, uN: r.uN, wn: r.wn, wt: r.wt, bJ: r.bJ}));
};
...
var $anmolitor$elm_grpc$Grpc$toCmd = F2(
	function (expect, _v0) {
		var req = _v0;
		var toHttpRequest = req.nm ? $elm$http$Http$riskyRequest : $elm$http$Http$request;
		var _v1 = req.k0;
		var rpc = _v1;
		var body = A2(
		...
		return toHttpRequest(
			{
				...
				iG: A2(
					...
					expect,
					$anmolitor$elm_grpc$Grpc$handleResponse(rpc.tx)),
				t9: req.t9,
				uN: 'POST',
				wn: req.wn,
				wt: req.wt,
				bJ: _Utils_ap(
					req.ft,
					$anmolitor$elm_grpc$Grpc$rpcPath(req.k0))
			});
	});
...
var $author$project$Pages$Dashboard$init = function (fromMainToDashboard) {
	var newModel = A8(
		...
		$elm$core$Maybe$Nothing,
		_List_Nil);
	var devOrProdServer = A2($elm$core$String$contains, $author$project$Extras$Constants$localorproductionServerAutoCheck, fromMainToDashboard.iL.ft) ? A6($elm$url$Url$Url, fromMainToDashboard.iL.nk, fromMainToDashboard.iL.ft, $elm$core$Maybe$Nothing, $author$project$Extras$Constants$productionProxyConfig, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing) : A6(
		$elm$url$Url$Url,
		fromMainToDashboard.iL.nk,
		fromMainToDashboard.iL.ft,
...
var $author$project$Pages$Hardware$ApiSpecifics = F2(
	function (maxResults, accessToken) {
		return {dI: accessToken, uK: maxResults};
	});
...
var $author$project$Data$User$emptyDescription = {nH: '', nZ: ''};
...
var $AdrianRibao$elm_derberos_date$Derberos$Date$Core$DateRecord = F8(
	function (year, month, day, hour, minute, second, millis, zone) {
		return {m4: day, ud: hour, nf: millis, ng: minute, nh: month, nq: second, on: year, nB: zone};
	});
...
var $author$project$Pages$Hardware$init = function (fromMainToRankings) {
	var updatedFlagUrlToIncludeMongoDBMWSvr = A2($elm$core$String$contains, $author$project$Extras$Constants$localorproductionServerAutoCheck, fromMainToRankings.iL.ft) ? A6($elm$url$Url$Url, fromMainToRankings.iL.nk, fromMainToRankings.iL.ft, $elm$core$Maybe$Nothing, $author$project$Extras$Constants$productionProxyConfig, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing) : A6(
		$elm$url$Url$Url,
		fromMainToRankings.iL.nk,
		fromMainToRankings.iL.ft,
		$elm$core$Maybe$Just(3000),
		$author$project$Extras$Constants$middleWarePath,
		$elm$core$Maybe$Nothing,
		$elm$core$Maybe$Nothing);
	return _Utils_Tuple2(
		$author$project$Pages$Hardware$Model(1)('Hardware')(
			{fU: 'Loading...'})(fromMainToRankings.iL)(
			A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Maybe$Nothing,
			...
			_List_fromArray(
				[$elm$core$Maybe$Nothing]))(false)(false)(
			{nP: '', n6: ''})($author$project$Data$Ranking$None)($author$project$Data$Ranking$emptyRank)($author$project$Data$User$emptySpectator)(2)('')(_List_Nil)($elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Pages$Support$init = function (_v0) {
	return _Utils_Tuple2(
		_Utils_update(
			...
			{wo: 'Haveno-Web Support'}),
		$elm$core$Platform$Cmd$none);
};
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {d7: frag, ek: params, dT: unvisited, am: value, eC: visited};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.f6),
					$elm$url$Url$Parser$prepareQuery(url.vq),
					url.tW,
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$DashboardPage(dashboard)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$FundsPage(funds)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$HardwarePage(hardware)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$MarketPage(market)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$PingPongPage(pingpong)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$PortfolioPage(portfolio)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$BuyPage(pricing)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$SellPage(sell)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					v: $author$project$Main$SupportPage(support)
				}),
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {q3: processes, rW: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.rW);
		if (_v0.$ === 1) {
			return $elm$core$Task$succeed(state);
		} else {
			var taggers = _v0.a;
...
var $author$project$Data$Ranking$abandonSingleUserChallenge = F2(
	function (userId, ranks) {
		return A2(
			$elm$core$List$map,
			function (rank) {
				return (_Utils_eq(rank.aC.B, userId) || _Utils_eq(rank.ap.B, userId)) ? _Utils_update(
					rank,
					{ap: $author$project$Data$Ranking$noChallengerCurrently}) : rank;
			},
			ranks);
	});
	...
	function (user, ranking) {
		if (user.$ === 1) {
			...
			var rankingExists = A2(
				$elm$core$List$any,
				function (r) {
					return _Utils_eq(r.B, ranking.B);
				},
				usrInfo.ec);
			if (rankingExists) {
				return user;
			} else {
				var newRankingList = A2($elm$core$List$cons, ranking, usrInfo.ec);
			...
			A2(
				...
				$elm$core$List$head(
					A2(
						$elm$core$List$filter,
						function (r) {
							return _Utils_eq(r.aC.B, playerId);
						},
						ranks))));
		return A2(
			$elm$core$List$map,
			function (rank) {
				return _Utils_eq(rank.aC.B, playerId) ? _Utils_update(
					rank,
					{ap: newChallenger}) : (_Utils_eq(rank.aC.B, newChallenger.B) ? _Utils_update(
					rank,
					{ap: player1}) : rank);
			},
			ranks);
	...
	function (user, rankingid) {
		if (user.$ === 1) {
			...
			return A2(
				$elm$core$List$filter,
				function (ranking) {
					return !_Utils_eq(ranking.B, rankingid);
				},
				usrInfo.ec);
		} else {
			return _List_Nil;
...
var $author$project$Data$Ranking$gotRankBelow = F2(
	function (rank, ranks) {
		var rankBelow = A2(
			$elm$core$List$filter,
			function (r) {
				return _Utils_eq(r.bG, rank.bG + 1);
			},
			ranks);
		if (!rankBelow.b) {
			return $elm$core$Maybe$Nothing;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'street',
				$elm$json$Json$Encode$string(baseaddress.lL)),
				_Utils_Tuple2(
				'city',
				$elm$json$Json$Encode$string(baseaddress.h2))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'playerId',
				$elm$json$Json$Encode$string(rank.aC.B)),
				_Utils_Tuple2(
				'challengerId',
				$elm$json$Json$Encode$string(rank.ap.B)),
				_Utils_Tuple2(
				'rank',
				$elm$json$Json$Encode$string(
					$elm$core$String$fromInt(rank.bG)))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'_id',
				$elm$json$Json$Encode$string(updatedRanking.B)),
				_Utils_Tuple2(
				'active',
				$elm$json$Json$Encode$bool(updatedRanking.mS)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(updatedRanking.fU)),
				_Utils_Tuple2(
				'owner_id',
				$elm$json$Json$Encode$string(updatedRanking.f3)),
				_Utils_Tuple2(
				'baseaddress',
				$author$project$Data$Ranking$encodeBaseAddress(updatedRanking.dK)),
				_Utils_Tuple2(
				'players',
				A2($elm$json$Json$Encode$list, $author$project$Data$Ranking$encodeRank, updatedRanking.nd)),
				_Utils_Tuple2(
				'lastUpdatedBy',
				$elm$json$Json$Encode$string(updatedRanking.f3))
			]));
	...
	function (playerId, ranks) {
		return A2(
			...
			A2(
				$elm$core$List$filter,
				function (rank) {
					return !_Utils_eq(rank.aC.B, playerId);
				},
				ranks));
	});
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								eB: $elm$core$Maybe$Just(versionResp)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
			...
			default:
				if (!msg.a.$) {
					...
					var headers = _List_fromArray(
						[
							...
							'Bearer ' + A2(
								$elm$core$Maybe$withDefault,
								'No access token 2',
								$elm$core$Maybe$Just(auth.pc)))
						]);
					var flagUrlWithMongoDBMWAndPortUpdate = A2($elm$core$String$contains, $author$project$Extras$Constants$localorproductionServerAutoCheck, model.iL.ft) ? $elm$url$Url$toString(
						A6($elm$url$Url$Url, model.iL.nk, model.iL.ft, $elm$core$Maybe$Nothing, $author$project$Extras$Constants$middleWarePath, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)) : $elm$url$Url$toString(
						A6(
							$elm$url$Url$Url,
							model.iL.nk,
							model.iL.ft,
					...
					var newModel = _Utils_update(
						model,
						{
							pM: $elm$core$Maybe$Just(newHttpParams)
						});
...
var $author$project$Pages$Hardware$JsonMsgFromJs = F3(
	function (operationEventMsg, dataFromMongo, additionalDataFromJs) {
		return {nD: additionalDataFromJs, pa: dataFromMongo, f0: operationEventMsg};
	});
...
var $author$project$Data$Ranking$Rank = F3(
	function (rank, player, challenger) {
		return {ap: challenger, aC: player, bG: rank};
	});
	...
	function (user, ranking) {
		if (user.$ === 1) {
			...
			if (rankingExists) {
				...
				var newRankingList = A2($elm$core$List$cons, ranking, usrInfo.dN);
				return $author$project$Data$User$Registered(
					_Utils_update(
						usrInfo,
						{dN: newRankingList}));
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.v$));
			default:
				var body = response.b;
				return A2(
...
var $author$project$Data$Ranking$Ranking = F8(
	function (id, active, name, owner_id, baseaddress, ladder, player_count, owner_name) {
		return {mS: active, dK: baseaddress, B: id, nd: ladder, fU: name, f3: owner_id, n5: owner_name, n8: player_count};
	});
var $author$project$Data$Ranking$BaseAddress = F2(
	function (street, city) {
		return {h2: city, lL: street};
	});
...
var $author$project$Pages$Hardware$callRequest = function (model) {
	var headers = _List_fromArray(
		[
			...
			$elm$http$Http$header,
			'Authorization',
			'Bearer ' + A2($elm$core$Maybe$withDefault, 'No access token ', model.ao.dI))
		]);
	var therequest = $elm$http$Http$request(
		{
			sZ: $elm$http$Http$jsonBody($author$project$Extras$Constants$callRequestJson),
			iG: A2(
			...
			wn: $elm$core$Maybe$Nothing,
			wt: $elm$core$Maybe$Nothing,
			bJ: 'https://ap-southeast-1.aws.realm.mongodb.com/api/client/v2.0/app/sr-espa1-snonq/functions/call'
		});
	return therequest;
};
var $author$project$Pages$Hardware$Change = F4(
	function (operationType, documentKey, updateDescription, fullDocument) {
		return {pi: documentKey, m6: fullDocument, ke: operationType, nA: updateDescription};
	});
...
var $author$project$Pages$Hardware$FullDocument = F7(
	function (id, active, name, players, ownerId, baseAddress, lastUpdatedBy) {
		return {mS: active, sT: baseAddress, B: id, p9: lastUpdatedBy, fU: name, vc: ownerId, qX: players};
	});
...
var $author$project$Pages$Hardware$PlayerFromChangeEvent = F3(
	function (playerId, challengerId, rank) {
		return {s7: challengerId, n7: playerId, bG: rank};
	});
...
var $author$project$Pages$Hardware$UpdateDescription = F3(
	function (updatedFields, removedFields, truncatedArrays) {
		return {ob: removedFields, r6: truncatedArrays, oh: updatedFields};
	});
...
var $author$project$Pages$Hardware$emptyChange = {
	...
	ke: '',
	nA: {ob: _List_Nil, r6: _List_Nil, oh: $elm$core$Dict$empty}
};
		...
		return A2(
			...
			A2(
				...
				A2(
					$elm$core$List$filter,
					function (ranking) {
						return A2($elm$core$List$member, ranking.aC.B, changePlayerIds);
					},
...
var $author$project$Data$Ranking$isCurrentlyInAChallenge = function (rank) {
	return (_Utils_eq(rank.aC.B, $author$project$Extras$Constants$noCurrentChallengerId) || _Utils_eq(rank.ap.B, $author$project$Extras$Constants$noCurrentChallengerId)) ? false : true;
};
...
var $author$project$Pages$Hardware$SuccessfullLocationResult = F4(
	function (deployment_model, location, hostname, ws_hostname) {
		return {pc: deployment_model, uc: hostname, uI: location, wD: ws_hostname};
	});
	...
	var therequest = $elm$http$Http$request(
		{
			...
			iG: A2($elm$http$Http$expectJson, $author$project$Pages$Hardware$LocationResponse, $author$project$Pages$Hardware$locationDecoder),
			t9: _List_Nil,
			uN: 'GET',
			wn: $elm$core$Maybe$Nothing,
			wt: $elm$core$Maybe$Nothing,
			bJ: 'https://realm.mongodb.com/api/client/v2.0/app/sr-espa1-snonq/location'
		});
	return therequest;
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(emailPword.nP)),
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(emailPword.n6))
			]));
};
var $author$project$Pages$Hardware$SuccessfulLoginResult = F4(
	function (access_token, refresh_token, user_id, device_id) {
		return {nC: access_token, tD: device_id, vt: refresh_token, sc: user_id};
	});
...
var $author$project$Pages$Hardware$loginRequest = function (model) {
	var therequest = $elm$http$Http$request(
		{
			sZ: $elm$http$Http$jsonBody(
				$author$project$Pages$Hardware$prepareEmailPwordLogin(model.bL)),
			iG: A2($elm$http$Http$expectJson, $author$project$Pages$Hardware$LoginResponse, $author$project$Pages$Hardware$successfullLoginResultDecoder),
			t9: _List_fromArray(
				[
			...
			wn: $elm$core$Maybe$Nothing,
			wt: $elm$core$Maybe$Nothing,
			bJ: 'https://ap-southeast-1.aws.realm.mongodb.com/api/client/v2.0/app/sr-espa1-snonq/auth/providers/local-userpass/login'
		});
	return therequest;
};
...
var $author$project$Data$Ranking$newlyJoinedRankingIdAsValueManipulation = function (newlyJoinedRanking) {
	var jsonEncodedId = $elm$core$String$trim(
		A2($elm$json$Json$Encode$encode, 0, newlyJoinedRanking.B));
	var trimmedId = A2(
		$elm$core$String$dropLeft,
		1,
...
var $author$project$Pages$Hardware$SuccessfullProfileResult = F5(
	function (user_id, domain_id, identities, data, typeOfData) {
		return {tu: data, tH: domain_id, ui: identities, r7: typeOfData, sc: user_id};
	});
var $author$project$Pages$Hardware$Identities = F4(
	function (id, provider_type, provider_id, provider_data) {
		return {B: id, vm: provider_data, vn: provider_id, vo: provider_type};
	});
...
var $author$project$Pages$Hardware$profileRequest = function (model) {
	...
	var therequest = $elm$http$Http$request(
		{
			sZ: $elm$http$Http$emptyBody,
			iG: A2($elm$http$Http$expectJson, $author$project$Pages$Hardware$ProfileResponse, $author$project$Pages$Hardware$profileDecoder),
			t9: headers,
			uN: 'GET',
			wn: $elm$core$Maybe$Nothing,
			wt: $elm$core$Maybe$Nothing,
			bJ: 'https://ap-southeast-1.aws.realm.mongodb.com/api/client/v2.0/auth/profile'
		});
	return therequest;
};
...
var $author$project$Pages$Hardware$sendPostDataToMongoDBMW = function (model) {
	...
	var headers = _List_fromArray(
		[
			...
			$elm$http$Http$header,
			'Authorization',
			'Bearer ' + A2($elm$core$Maybe$withDefault, 'No access token 1', model.ao.dI)),
			A2($elm$http$Http$header, 'Accept', 'application/json')
		]);
	...
	var therequest = $elm$http$Http$request(
		{sZ: toMongoDBMWConfig.sZ, iG: expectData, t9: headers, uN: 'POST', wn: $elm$core$Maybe$Nothing, wt: $elm$core$Maybe$Nothing, bJ: 'http://localhost:3000/middleware'});
	return therequest;
};
		...
		switch (msg.$) {
			case 50:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bO: $author$project$Pages$Hardware$MemberSelectedView}),
					$elm$core$Platform$Cmd$none);
			case 61:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bO: $author$project$Pages$Hardware$ConfirmDeleteUserView}),
					$elm$core$Platform$Cmd$none);
			case 62:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bO: $author$project$Pages$Hardware$Login($author$project$Extras$Constants$emptyEmailPassword)
						}),
					$elm$core$Platform$Cmd$none);
			case 58:
			...
			case 60:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bO: $author$project$Pages$Hardware$ConfirmLeaveMemberView}),
					$elm$core$Platform$Cmd$none);
			case 57:
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 55:
				...
				if (_v2.$ === 1) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bO: $author$project$Pages$Hardware$ConfirmJoinMemberView}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bO: $author$project$Pages$Hardware$RegisterUser($author$project$Data$User$emptyUserInfo)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 34:
			...
			case 45:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bO: $author$project$Pages$Hardware$ConfirmDeleteOwnedRanking}),
					$elm$core$Platform$Cmd$none);
			case 41:
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							et: $author$project$Data$Ranking$Owned(
								A2(
			...
			case 28:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bO: $author$project$Pages$Hardware$CreatingNewLadder(userInfo),
							et: $author$project$Data$Ranking$Owned(
								_Utils_update(
									newRanking,
									{
			...
			case 25:
				...
				var json = $author$project$Pages$Hardware$ensureDataIsJsonObj(decodedJsObj.pa);
				var newRanking = function () {
					var _v16 = decodedJsObj.f0;
					switch (_v16) {
						case 'ownedranking':
						...
						case 'CreatedNewRanking':
							return model.et;
						case 'webSocket':
							var currentSelectedRanking = $author$project$Data$Ranking$gotRanking(model.et);
							var chnge = function () {
							...
							var newRking = _Utils_update(
								...
								{
									nd: newLadder,
									n8: $elm$core$List$length(newLadder)
								});
							var updatedFieldsList = $elm$core$Dict$toList(chnge.nA.oh);
								...
								if ($author$project$Pages$Hardware$is24AlphanumericChars(insertedId)) {
									var userUpdatedWithNewRanking = A2(
										...
										A3(
											...
											insertedId,
											$author$project$Data$Ranking$gotRanking(model.et).n5,
					...
					function () {
						...
						switch (_v25.$) {
							case 9:
								return _Utils_update(
									model,
									{bO: $author$project$Pages$Hardware$OwnedSelectedView});
							case 11:
								return _Utils_update(
									model,
									{bO: $author$project$Pages$Hardware$MemberSelectedView});
			...
			case 24:
				...
				var updatedFlagUrlToIncludeMongoDBMWSvr = A2($elm$core$String$contains, $author$project$Extras$Constants$localorproductionServerAutoCheck, model.iL.ft) ? $elm$url$Url$toString(
					A6($elm$url$Url$Url, model.iL.nk, model.iL.ft, $elm$core$Maybe$Nothing, $author$project$Extras$Constants$productionProxyConfig, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)) : $elm$url$Url$toString(
					A6(
						$elm$url$Url$Url,
						model.iL.nk,
						model.iL.ft,
			...
			case 17:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{nI: dateTimeOnlyUpdatedIfNotSelected}),
					$elm$core$Platform$Cmd$none);
			case 16:
				return _Utils_Tuple2(
					_Utils_update(
				...
				if (!msg.a.$) {
					...
					var headers = _List_fromArray(
						[
							...
							$elm$http$Http$header,
							'Authorization',
							'Bearer ' + A2($elm$core$Maybe$withDefault, 'No access token', auth.wr))
						]);
					var flagUrlWithMongoDBMWAndPortUpdate = A2($elm$core$String$contains, $author$project$Extras$Constants$localorproductionServerAutoCheck, model.iL.ft) ? $elm$url$Url$toString(
						A6($elm$url$Url$Url, model.iL.nk, model.iL.ft, $elm$core$Maybe$Nothing, $author$project$Extras$Constants$middleWarePath, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing)) : $elm$url$Url$toString(
						A6(
					...
					var excludeByRankingIds = F2(
						function (searchResults, rankings) {
							...
							return A2(
								$elm$core$List$filter,
								function (result) {
									return !A2($elm$core$List$member, result.B, rankingIds);
								},
								searchResults);
						});
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								fC: false,
								vM: A2(excludeByRankingIds, searchResult.ru, gotUsersMemberAndOwnedRankings)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var responseErr = msg.a.a;
					...
					var newModel = _Utils_update(
						model,
						{
							ao: _Utils_update(
								apiSpecs,
								{
									dI: $elm$core$Maybe$Just(auth.nC)
								}),
							ea: true,
							bO: $author$project$Pages$Hardware$LoggedInUser,
							dH: $elm$core$Maybe$Just(newHttpParams)
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								fC: false,
								et: $author$project$Data$Ranking$Spectator(specRankingResult)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var responseErr = msg.a.a;
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'message',
				$elm$json$Json$Encode$string(request.jU))
			]));
};
				...
				var therequest = $elm$http$Http$request(
					{
						sZ: $elm$http$Http$jsonBody(
							$author$project$Pages$PingPong$encodePingRequest(
								{jU: 'Ping'})),
						iG: A2($elm$http$Http$expectJson, $author$project$Pages$PingPong$Receive, $author$project$Pages$PingPong$decodePongResponse),
						t9: _List_Nil,
						uN: 'POST',
						wn: $elm$core$Maybe$Nothing,
						wt: $elm$core$Maybe$Nothing,
						bJ: 'http://localhost:9001/ping'
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								rj: {fU: 'Error receiving response'}
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
			...
			case 12:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							nB: $elm$core$Maybe$Just(newZone)
						}),
					$elm$core$Platform$Cmd$none);
			case 0:
					...
					switch (rankingsMsg.$) {
						case 44:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										v: $author$project$Main$HardwarePage(newRankingsModel)
									}),
								$author$project$Main$sendMessage(
									'createRanking' + ('~^&' + (ranking.fU + ('~^&' + (((ranking.dK.lL === '') ? 'Unspecified' : ranking.dK.lL) + ('~^&' + ((ranking.dK.h2 === '') ? 'Unspecified' : ranking.dK.h2))))))));
						case 36:
							...
							return _Utils_Tuple2(
								...
								$author$project$Main$sendMessage('fetchRanking' + ('~^&' + (ownedRanking.B + '~^&ownedranking'))));
						case 37:
							...
							return _Utils_Tuple2(
								...
								$author$project$Main$sendMessage('fetchRanking' + ('~^&' + (memberRanking.B + '~^&memberranking'))));
						case 57:
							...
							return _Utils_Tuple2(
										...
										v: $author$project$Main$HardwarePage(
											_Utils_update(
												rankings,
												{
													...
													vM: _List_Nil,
													vN: '',
													et: $author$project$Data$Ranking$Member(
														_Utils_update(
															rankingWantToJoin,
								...
								$author$project$Main$sendMessage(
									'joinRanking' + ('~^&' + (rankingWantToJoin.B + ('~^&' + (userid + ('~^&' + $elm$core$String$fromInt(lastRank + 1))))))));
						case 58:
							...
							var updatedRanking = _Utils_update(
								rankingWantToLeave,
								{
									nd: A2($author$project$Data$Ranking$removeRank, userid, rankingWithAnyCurrentChallengesRemoved)
								});
							return _Utils_Tuple2(
								_Utils_update(
									model,
								...
								$author$project$Main$sendMessage(
									'leaveRanking' + ('~^&' + (rankingWantToLeave.B + ('~^&' + (userid + ('~^&' + A2(
						...
						case 48:
							...
							var gotRankBelow = A2(
								$elm$core$Maybe$withDefault,
								$author$project$Data$Ranking$emptyRank,
								A2($author$project$Data$Ranking$gotRankBelow, rank, selectedRanking.nd));
							var updatedRanks = A3($author$project$Data$Ranking$createSingleUserChallenge, rank.aC.B, gotRankBelow.aC, selectedRanking.nd);
							var updatedRanking = _Utils_update(
								selectedRanking,
								{nd: updatedRanks});
							return _Utils_Tuple2(
									...
									model,
									{
										v: $author$project$Main$HardwarePage(
											_Utils_update(
												...
												{
													bO: $author$project$Pages$Hardware$MemberSelectedView,
													et: $author$project$Data$Ranking$Member(updatedRanking)
												}))
									}),
								$author$project$Main$sendMessage(
									'updateRanking' + ('~^&' + (selectedRanking.B + ('~^&' + A2(
										$elm$json$Json$Encode$encode,
										0,
										$author$project$Data$Ranking$jsonUpdatedRanking(updatedRanking)))))));
						case 49:
							var result = rankingsMsg.a;
							var selectedRanking = $author$project$Data$Ranking$gotRanking(rankings.et);
							var updatedRanks = A3(
									...
									model,
									{
										v: $author$project$Main$HardwarePage(
											_Utils_update(
												rankings,
												{
													bO: $author$project$Pages$Hardware$RegisterUser(newUserRegistrationDetails)
												}))
									}),
								$author$project$Main$sendMessage(
							...
							return _Utils_Tuple2(
								...
								$author$project$Main$sendMessage(
									'deleteRanking' + ('~^&' + $author$project$Data$Ranking$gotRankingId(
										$author$project$Data$Ranking$gotRanking(rankings.et)))));
						case 62:
							return _Utils_Tuple2(
								_Utils_update(
									model,
	...
	var links = A2(
		...
		_List_fromArray(
			[
				...
				navLink,
				4,
				{bn: 'Support', bJ: 'support'}),
				A2(
				navLink,
				5,
				{bn: 'PingPong', bJ: 'pingpong'}),
				A2(
				navLink,
				1,
				{bn: 'Sell', bJ: 'sell'}),
				...
				navLink,
				8,
				{bn: 'Hardware', bJ: 'hardware'}),
				A2(
				navLink,
				2,
				{bn: 'Portfolio', bJ: 'portfolio'})
			]));
	return links;
};
	...
	var links = A2(
		...
		_List_fromArray(
			[
				...
				navLink(
				{bn: 'other potential support', bJ: 'support'})
			]));
	return links;
}();
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {sw: 'a', mS: 'atv', sB: 'ab', sC: 'cx', sD: 'cy', sE: 'acb', sF: 'accx', sG: 'accy', sH: 'acr', oB: 'al', oC: 'ar', sI: 'at', nE: 'ah', nF: 'av', sL: 's', sV: 'bh', sW: 'b', s_: 'w7', s0: 'bd', s1: 'bdt', mU: 'bn', s2: 'bs', mY: 'cpe', td: 'cp', te: 'cpx', tf: 'cpy', dL: 'c', m$: 'ctr', m0: 'cb', m1: 'ccx', dM: 'ccy', h6: 'cl', m2: 'cr', tp: 'ct', ts: 'cptr', tt: 'ctxt', tV: 'fcs', px: 'focus-within', t_: 'fs', t7: 'g', nT: 'hbh', nU: 'hc', pN: 'he', nV: 'hf', pO: 'hfp', ue: 'hv', uk: 'ic', um: 'fr', nb: 'lbl', uq: 'iml', ur: 'imlf', us: 'imlp', ut: 'implw', uu: 'it', uC: 'i', qd: 'lnk', fW: 'nb', qz: 'notxt', u2: 'ol', u3: 'or', ej: 'oq', vb: 'oh', v: 'pg', qL: 'p', ve: 'ppe', rj: 'ui', rl: 'r', vI: 'sb', vJ: 'sbx', vK: 'sby', vL: 'sbt', vT: 'e', vV: 'cap', vW: 'sev', v3: 'sk', bj: 't', v9: 'tc', wa: 'w8', wb: 'w2', wc: 'w9', wd: 'tj', nv: 'tja', we: 'tl', wf: 'w3', wg: 'w5', wh: 'w4', wi: 'tr', wj: 'w6', wk: 'w1', wl: 'tun', r5: 'ts', ey: 'clr', wu: 'u', ok: 'wc', sq: 'we', ol: 'wf', sr: 'wfp', om: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dL);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.t7);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.v);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.qL);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.rl);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.vT);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.vF)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
...
var $mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.pY ? $elm$core$Maybe$Just('inset') : $elm$core$Maybe$Nothing,
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.ka.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.ka.b) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.sY) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.vU) + 'px'),
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.th))
				])));
};
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.px) + ':focus-within',
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
								...
								$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
									{
										...
										ka: A2(
											...
											A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.ka)),
										vU: shadow.vU
									}));
						},
						focus.vS),
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ':focus .focusable, ') + (($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + '.focusable:focus, ') + ('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ' .focusable-thumb'))),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Style$contentName = function (desc) {
	switch (desc) {
		case 0:
			var _v1 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.tp);
		case 1:
			var _v2 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.m0);
		case 2:
			var _v3 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.m2);
		case 3:
			var _v4 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.h6);
		case 4:
			var _v5 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.m1);
		default:
			var _v6 = desc;
...
var $mdgriffith$elm_ui$Internal$Style$selfName = function (desc) {
	switch (desc) {
		case 0:
			var _v1 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sI);
		case 1:
			var _v2 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sB);
		case 2:
			var _v3 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.oC);
		case 3:
			var _v4 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.oB);
		case 4:
			var _v5 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sC);
		default:
			var _v6 = desc;
			return $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sD);
	}
};
	...
	[
		...
		_List_fromArray(
			[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Child,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sV),
				_List_fromArray(
					[
		...
		A2(
		$mdgriffith$elm_ui$Internal$Style$Descriptor,
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.vL),
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Internal$Style$Child,
...
var $mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		_Utils_ap(
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL),
			_Utils_ap(
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.vT),
		...
		A2(
		$mdgriffith$elm_ui$Internal$Style$Class,
		$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Child,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.um),
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Internal$Style$Descriptor,
		...
		_List_fromArray(
			[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.om),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ts),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.tt),
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ue, $mdgriffith$elm_ui$Internal$Style$classes.ey)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ue, $mdgriffith$elm_ui$Internal$Style$classes.ej)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.tV, $mdgriffith$elm_ui$Internal$Style$classes.ey)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.tV, $mdgriffith$elm_ui$Internal$Style$classes.ej)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.mS, $mdgriffith$elm_ui$Internal$Style$classes.ey)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.mS, $mdgriffith$elm_ui$Internal$Style$classes.ej)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.r5),
				_List_fromArray(
					[
						A2(
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.tf),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s0),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s1),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s2),
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'border-style', 'solid')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sH,
						_List_fromArray(
							[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sF,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sF,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sF,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.sF + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.sH + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.sF)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Descriptor,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.vW),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sE,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sG,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sG,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.sG,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.sG + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.sE + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.sG)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.t7),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL + ':first-child'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.sL + ($mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.sL))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.sL + ($mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.sL))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ut),
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Internal$Style$Descriptor,
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.uC),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.v3),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.wu),
				_List_fromArray(
					[
				...
				A2(
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.v9),
				_List_fromArray(
					[
...
var $mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + ($mdgriffith$elm_ui$Internal$Style$classes.sL + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + ($mdgriffith$elm_ui$Internal$Style$classes.sL + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.rl) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.rl) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.m$) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {mZ: closing, aB: _List_Nil, dQ: _List_Nil, c3: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								aB: A2(
									$elm$core$List$cons,
									{mZ: '\n}', aB: _List_Nil, dQ: props, c3: '@supports (' + (prop + (':' + (value + (') {' + parent.c3))))},
									rendered.aB)
							});
					case 5:
						var selector = rule.a;
							...
							rendered,
							{
								aB: A2(
									...
									A2(
										...
										A2($mdgriffith$elm_ui$Internal$Style$emptyIntermediate, parent.c3 + (' + ' + selector), ''),
										adjRules),
									rendered.aB)
							});
					case 1:
						...
						return _Utils_update(
							rendered,
							{
								aB: A2(
									...
									A2(
										$mdgriffith$elm_ui$Internal$Style$renderRules,
										A2($mdgriffith$elm_ui$Internal$Style$emptyIntermediate, parent.c3 + (' > ' + child), ''),
										childRules),
									rendered.aB)
							});
					case 2:
								...
								aB: A2(
									...
									A2(
										...
										A2(
											...
											_Utils_ap(parent.c3, descriptor),
											''),
										descriptorRules),
									rendered.aB)
							});
						...
						return _Utils_update(
							rendered,
							{
								aB: A2(
									...
									A2(
										$mdgriffith$elm_ui$Internal$Style$renderRules,
										A2($mdgriffith$elm_ui$Internal$Style$emptyIntermediate, parent.c3, ''),
										batched),
									rendered.aB)
							});
				}
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.c3 + ('{' + (renderValues(rule.dQ) + (rule.mZ + '}')));
		}
	};
	var renderIntermediate = function (_v0) {
		...
		return _Utils_ap(
			...
			$elm$core$String$concat(
				A2($elm$core$List$map, renderIntermediate, rule.aB)));
	};
	return $elm$core$String$concat(
		A2(
			$elm$core$List$map,
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.se);
	} else {
		return false;
	}
};
				...
				case 0:
					...
					return _List_fromArray(
						[
							...
							('.' + ($mdgriffith$elm_ui$Internal$Style$classes.sL + (':focus ' + (selector + '-fs  {')))) + (renderedProps + '\n}'),
							(selector + '-fs:focus-within {') + (renderedProps + '\n}'),
							('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.sL) + (' .focusable-thumb' + (selector + '-fs {')))) + (renderedProps + '\n}')
						]);
				default:
					return _List_fromArray(
						[
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.se)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.vT;
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.rl;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.om + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.oC;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.qL;
				var page = '.' + $mdgriffith$elm_ui$Internal$Style$classes.v;
				var left = '.' + $mdgriffith$elm_ui$Internal$Style$classes.oB;
				var halfY = $elm$core$String$fromFloat(y / 2) + 'px';
				var halfX = $elm$core$String$fromFloat(x / 2) + 'px';
				var column = '.' + $mdgriffith$elm_ui$Internal$Style$classes.dL;
				var _class = '.' + cls;
				var any = '.' + $mdgriffith$elm_ui$Internal$Style$classes.sL;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A4(
			...
			case 8:
				...
				var xSpacing = toGridLength(template.vX.a);
				var ySpacing = toGridLength(template.vX.b);
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.vF)));
				var msRows = function (x) {
					...
					A2(
						$elm$core$String$join,
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.m_)));
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.m_)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.vX.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.vX.a) + ';');
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.vV, capital),
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.t_, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.vV + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.vV))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.vV + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.bj + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.vV + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.bj)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {iU: height / size, vU: size, sh: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.s5, adjustment.sU, adjustment.tB, adjustment.uJ]);
	var lineHeight = 1.5;
	...
	return {
		s5: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
		pz: A3($mdgriffith$elm_ui$Internal$Model$adjust, fullSize, ascender - descender, fullVertical)
	};
};
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'vertical-align',
				$elm$core$String$fromFloat(converted.sh) + 'em'),
				_Utils_Tuple2(
				'font-size',
				$elm$core$String$fromFloat(converted.vU) + 'em')
			]));
};
				...
				return {
					...
					l4: function () {
						...
						if (_v1.$ === 1) {
							...
							var topLevel = _v1.a;
							return A2($elm$core$List$cons, topLevel, rendered.l4);
						}
					}()
				};
			});
	...
	function (_static, opts, styles, children) {
		var dynamicStyleSheet = A2(
			...
			A3(
				...
				_Utils_Tuple2(
					$elm$core$Set$empty,
					$mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.tV)),
				styles).b);
		return _static ? A2(
			$elm$core$List$cons,
			_Utils_Tuple2(
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.vT))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.sL, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.m$, $mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.sH])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.sL, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.m$, $mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.sF])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.sL, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.m$, $mdgriffith$elm_ui$Internal$Style$classes.sG])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.sL, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.m$, $mdgriffith$elm_ui$Internal$Style$classes.sE])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bj + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ok + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.nU)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.sL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bj + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ol + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.nV)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.ug, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.rT : _Utils_ap(styled.rT, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.ug, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.rT : _Utils_ap(styled.rT, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.rT : _Utils_ap(rendered.rT, styles);
			if (!newStyles.b) {
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.ta)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.ta)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.fW, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.sw]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
							...
							case 2:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.fW, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.u3]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.fW, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.u2]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.fW, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.um]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.fW, $mdgriffith$elm_ui$Internal$Style$classes.vT, $mdgriffith$elm_ui$Internal$Style$classes.sV]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.ug, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.nE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.oB);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.nE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.oC);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.nE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.sC);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.nF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.sI);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.nF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.sB);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.nF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.sD);
	}
};
	...
	switch (h.$) {
		...
		case 1:
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.nU,
				_List_Nil);
		case 2:
			var portion = h.a;
			return (portion === 1) ? _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.nV,
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.sL + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dL + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.sq + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 1:
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.ok,
				_List_Nil);
		case 2:
			var portion = w.a;
			return (portion === 1) ? _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.ol,
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.sr + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.sL + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.rl + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.sq + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
									...
									continue gatherAttrRecursive;
								case 1:
									var $temp$classes = classes + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ok),
										$temp$node = node,
										$temp$has = A2(
								...
								case 2:
									var portion = width.a;
									if (portion === 1) {
										var $temp$classes = classes + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ol),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.sr + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									continue gatherAttrRecursive;
								case 1:
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.nU + (' ' + classes),
										$temp$node = node,
										$temp$has = A2(
										$mdgriffith$elm_ui$Internal$Flag$add,
								...
								case 2:
									...
									if (portion === 1) {
										var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.nV + (' ' + classes),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.rT);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.tp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.h6)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Pages$Hardware$CancelFetchedMember = {$: 31};
var $author$project$Pages$Hardware$DeleteAccount = {$: 62};
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.s_);
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.ts);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.m1 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.vL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.qz)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.v9);
...
var $mdgriffith$elm_ui$Internal$Model$boxShadowClass = function (shadow) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				shadow.pY ? 'box-inset' : 'box-',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.ka.a) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.ka.b) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.sY) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.vU) + 'px',
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.th)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {sY: almostShade.sY, th: almostShade.th, pY: false, ka: almostShade.ka, vU: almostShade.vU};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
	...
	_Utils_ap(
		...
		_List_fromArray(
			[
				...
				{
					sY: 10,
					th: A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.05),
					ka: _Utils_Tuple2(0, 2),
					vU: 1
				}),
	...
	$mdgriffith$elm_ui$Element$focusStyle(
		{
			...
			s$: $elm$core$Maybe$Just($Orasund$elm_ui_framework$Framework$Color$turquoise),
			vS: $elm$core$Maybe$Just(
				{
					sY: 10,
					th: $Orasund$elm_ui_framework$Framework$Color$turquoise,
					ka: _Utils_Tuple2(0, 0),
					vU: 1
				})
		}));
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	vS: $elm$core$Maybe$Just(
		{
			sY: 0,
			th: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
			ka: _Utils_Tuple2(0, 0),
			vU: 3
		})
};
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								ue: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
				case 1:
					...
					if (_v5.$ === 1) {
						return _Utils_update(
							record,
							{
								tV: $elm$core$Maybe$Just(focusStyle)
							});
					} else {
						return record;
					}
				default:
					...
					if (_v6.$ === 1) {
						return _Utils_update(
							record,
							{
								uQ: $elm$core$Maybe$Just(renderMode)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{tV: $elm$core$Maybe$Nothing, ue: $elm$core$Maybe$Nothing, uQ: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.rj, $mdgriffith$elm_ui$Internal$Style$classes.sL, $mdgriffith$elm_ui$Internal$Style$classes.vT]))),
...
var $Orasund$elm_ui_framework$Framework$layout = function (attributes) {
	return A2(
		...
		{va: $Orasund$elm_ui_framework$Framework$layoutOptions},
...
var $author$project$Pages$Hardware$CancelFetchedSpectator = {$: 32};
				...
				function (currentMax, remainingList) {
					...
					while (true) {
						if (!remainingList.b) {
							...
							if (_Utils_cmp(next.bG, currentMax.bG) > 0) {
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.h6 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.om)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
							...
							[
								...
								A3(
									...
									A2(
										$elm$core$Maybe$withDefault,
										$author$project$Data$Ranking$emptyRank,
										$author$project$Data$Ranking$gotLowestRank(ranking.nd)).bG)),
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Pages$Hardware$infoBtn,
								'Leave',
								A2($author$project$Pages$Hardware$ConfirmLeaveMemberRanking, ranking, userInfo.sd)),
								A2($author$project$Pages$Hardware$infoBtn, 'Cancel', $author$project$Pages$Hardware$CancelFetchedMember)
							]))
					])));
	});
var $author$project$Pages$Hardware$Cancel = {$: 29};
		...
		var userRank = A2(
			...
			$elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (r) {
						return _Utils_eq(r.aC.B, userInfo.sd);
					},
					ranking.nd)));
		var otherRank = A2(
			$elm$core$Maybe$map,
...
var $Orasund$elm_ui_framework$Framework$Grid$section = _Utils_ap(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$Border$color($Orasund$elm_ui_framework$Framework$Color$lightGrey),
			$mdgriffith$elm_ui$Element$paddingEach(
			{oR: 30, qa: 0, ri: 0, rZ: 10})
		]));
var $author$project$Pages$Hardware$createChallengeView = F3(
	function (uinfo, rank, ranking) {
		return (!_Utils_eq(rank.aC.B, uinfo.sd)) ? ((!A2($author$project$Pages$Hardware$isUserRankedHigher, uinfo, ranking)) ? A2(
			$Orasund$elm_ui_framework$Framework$responsiveLayout,
			_List_Nil,
			A2(
				$mdgriffith$elm_ui$Element$column,
								...
								_List_fromArray(
									[
										...
										_Utils_ap($Orasund$elm_ui_framework$Framework$Button$simple, $Orasund$elm_ui_framework$Framework$Color$simple),
										{
											...
											as: $elm$core$Maybe$Just($author$project$Pages$Hardware$Cancel)
										}),
										A2(
										$mdgriffith$elm_ui$Element$Input$button,
...
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.we);
var $mdgriffith$elm_ui$Element$rgb = F3(
	function (r, g, b) {
		return A4($mdgriffith$elm_ui$Internal$Model$Rgba, r, g, b, 1);
	});
var $author$project$SR$Elements$colors = {
	oO: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	mT: A3($mdgriffith$elm_ui$Element$rgb255, 2, 7, 239),
	o4: A3($mdgriffith$elm_ui$Element$rgb255, 204, 75, 75),
	o9: A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9),
	pJ: A3($mdgriffith$elm_ui$Element$rgb255, 0, 153, 0),
	pK: A3($mdgriffith$elm_ui$Element$rgb, 0.9, 0.9, 0.9),
	qb: A3($mdgriffith$elm_ui$Element$rgb255, 0, 128, 255),
	q5: A3($mdgriffith$elm_ui$Element$rgb255, 102, 0, 102),
	q6: A3($mdgriffith$elm_ui$Element$rgb, 0.8, 0, 0),
	so: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
};
...
var $author$project$SR$Elements$ladderCityValidation = function (ranking) {
	return $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.dK.h2) ? A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$SR$Elements$colors.pJ),
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$SR$Elements$colors.mT),
						$mdgriffith$elm_ui$Element$Font$alignLeft
					])),
			_List_fromArray(
				[
...
var $author$project$SR$Elements$ladderNameValidation = function (ranking) {
	return $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.fU) ? A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			A2(
				$elm$core$List$append,
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$SR$Elements$colors.q6),
						$mdgriffith$elm_ui$Element$Font$alignLeft
					])),
			_List_fromArray(
				[
...
var $author$project$SR$Elements$ladderStreetValidation = function (ranking) {
	return $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.dK.lL) ? A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			A2(
				$elm$core$List$append,
...
var $author$project$Pages$Hardware$CancelCreateNewRanking = {$: 33};
...
var $author$project$Pages$Hardware$isValidatedForAllLadderDetailsInput = function (ranking) {
	return $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.fU) && (((ranking.dK.lL === '') || $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.dK.lL)) && ((ranking.dK.h2 === '') || $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.dK.h2)));
};
...
var $author$project$Pages$Hardware$rankingDetailsConfirmPanel = F2(
	function (ranking, userInfo) {
		return $author$project$Pages$Hardware$isValidatedForAllLadderDetailsInput(ranking) ? A2(
			...
			_List_fromArray(
				[
					((ranking.dK.lL === '') && (ranking.dK.h2 === '')) ? $author$project$SR$Elements$warningParagraph : $mdgriffith$elm_ui$Element$text('Click to continue ...'),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									{
										C: $mdgriffith$elm_ui$Element$text('Cancel'),
										as: $elm$core$Maybe$Just($author$project$Pages$Hardware$CancelCreateNewRanking)
									}),
									A2(
									$mdgriffith$elm_ui$Element$Input$button,
									_Utils_ap(
			...
			switch (position) {
				case 2:
					return A4(
						...
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.nb),
							attrs),
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							_List_fromArray(
								[labelElement, input])));
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.td);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {oR: -box.oR, qa: -box.qa, ri: -box.ri, rZ: -box.rZ};
};
					...
					case 5:
						...
						return _Utils_update(
							els,
							{
								...
								aA: A2($elm$core$List$cons, attr, els.aA),
								z: A2($elm$core$List$cons, attr, els.z),
								g2: A2($elm$core$List$cons, attr, els.g2)
							});
					case 7:
						var cls = attr.a;
						var _v2 = attr.b;
							...
							return _Utils_update(
								els,
								{
									...
									aA: A2(
										$elm$core$List$cons,
										newHeight,
										A2($elm$core$List$cons, newLineHeight, els.aA)),
									z: A2($elm$core$List$cons, reducedVerticalPadding, els.z)
								});
						}
					case 6:
						var _v3 = attr.b;
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			return {
				...
				g2: $elm$core$List$reverse(redist.g2)
			};
		}(
			A3(
				$elm$core$List$foldl,
				A2($mdgriffith$elm_ui$Element$Input$redistributeOver, isMultiline, stacked),
				{bp: _List_Nil, aa: _List_Nil, aA: _List_Nil, z: _List_Nil, g2: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.qz + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ve)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.vK);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
					...
					if (!_v4.$) {
						...
						return _List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.uu)
							]);
					} else {
						return _List_fromArray(
							[
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.bg)),
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.C),
							$mdgriffith$elm_ui$Element$Input$spellcheck(textInput.da),
							A2(
							$elm$core$Maybe$withDefault,
							$mdgriffith$elm_ui$Internal$Model$NoAttribute,
							A2($elm$core$Maybe$map, $mdgriffith$elm_ui$Element$Input$autofill, textInput.bU))
						]),
					redistributed.aA)),
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.px),
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ut)
								])),
						redistributed.z),
					$mdgriffith$elm_ui$Internal$Model$Unkeyed(
						_List_fromArray(
											...
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.ur)
															]),
														_List_fromArray(
															[
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.bp, textOptions.bj === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.tt),
				A2(
					$elm$core$List$cons,
					...
					A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Region$announce, redistributed.aa))),
			textOptions.C,
			wrappedInput);
	});
								...
								_List_fromArray(
									[
												...
												])),
										{
											...
											bg: $author$project$Pages$Hardware$RankingNameChg,
												...
												])),
										{
											...
											bg: $author$project$Pages$Hardware$StreetAddressChg,
											bh: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
												...
												])),
										{
											...
											bg: $author$project$Pages$Hardware$CityAddressChg,
											bh: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
...
var $author$project$SR$Elements$ownedSelectedRankingHeaderEl = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		$Orasund$elm_ui_framework$Framework$Heading$h5,
		$mdgriffith$elm_ui$Element$text(r.n5 + (' this your owned ranking' + (' - ' + (r.fU + (' . \n Id is: ' + r.B))))));
};
...
var $author$project$Pages$Hardware$DeleteOwnedRanking = {$: 46};
...
var $author$project$Pages$Hardware$CancelDialoguePrepareResultView = {$: 50};
...
var $author$project$Data$Ranking$isUserOwnerOfRankning = F2(
	function (userid, ranking) {
		return _Utils_eq(ranking.f3, userid) ? true : false;
	});
...
var $author$project$Pages$Hardware$DialogueConfirmDeleteAccount = {$: 61};
var $author$project$Pages$Hardware$LogOut = {$: 26};
var $author$project$Pages$Hardware$Create = {$: 27};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$info),
				{
					C: $mdgriffith$elm_ui$Element$text(ranking.fU),
					as: $elm$core$Maybe$Just(
		...
		_List_fromArray(
			[
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$info),
				{
					C: $mdgriffith$elm_ui$Element$text(ranking.fU),
					as: $elm$core$Maybe$Just(
						$author$project$Pages$Hardware$FetchSpectatorRanking(ranking.B))
				})
			]));
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$column,
						_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
						A2($elm$core$List$map, $author$project$Pages$Hardware$ownedRankingBtn, userInfo.dN)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_framework$Framework$Heading$h5,
						...
						$mdgriffith$elm_ui$Element$column,
						_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
						A2($elm$core$List$map, $author$project$Pages$Hardware$memberRankingBtn, userInfo.ec)),
						A2(
						$mdgriffith$elm_ui$Element$wrappedRow,
						_Utils_ap($Orasund$elm_ui_framework$Framework$Card$fill, $Orasund$elm_ui_framework$Framework$Grid$simple),
						_List_fromArray(
								...
								_List_fromArray(
									[
												...
												])),
										{
											...
											bg: $author$project$Pages$Hardware$SubmitSearchForm,
											bh: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Pages$Hardware$infoBtn,
					'Connect Wallet',
					$author$project$Pages$Hardware$ClickedLogInUser(model.bL)),
					function () {
					var _v0 = model.d1;
					if (!_v0.b) {
...
var $author$project$Pages$Hardware$DialogueConfirmLeaveView = {$: 60};
...
var $author$project$Pages$Hardware$determineButtonType = F2(
	function (loggedInUsersRank, rankBeingIterated) {
		var rankBeingIteratedIsInAChallenge = !_Utils_eq(rankBeingIterated.ap.B, $author$project$Extras$Constants$noCurrentChallengerId);
		var loggedInUserIsInAChallenge = !_Utils_eq(loggedInUsersRank.ap.B, $author$project$Extras$Constants$noCurrentChallengerId);
		return loggedInUserIsInAChallenge ? (_Utils_eq(loggedInUsersRank.aC.B, rankBeingIterated.aC.B) ? 1 : (_Utils_eq(loggedInUsersRank.aC.B, rankBeingIterated.ap.B) ? 2 : 4)) : (rankBeingIteratedIsInAChallenge ? (_Utils_eq(loggedInUsersRank.aC.B, rankBeingIterated.aC.B) ? 1 : 2) : (_Utils_eq(loggedInUsersRank.bG - 1, rankBeingIterated.bG) ? 3 : 4));
	});
	...
	function (userid, ladder) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (r) {
					return _Utils_eq(r.aC.B, userid);
				},
				ladder));
	});
var $author$project$Pages$Hardware$playerbuttons = F2(
	function (r, u) {
		var currentUserRank = A2(
			$elm$core$Maybe$withDefault,
			$author$project$Data$Ranking$emptyRank,
			A2($author$project$Pages$Hardware$findUserRank, u.sd, r.nd));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$Orasund$elm_ui_framework$Framework$Grid$section,
			_List_fromArray(
...
var $author$project$Pages$Hardware$DialogDeleteOwnedRanking = {$: 45};
...
var $mdgriffith$elm_ui$Element$Input$email = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		bU: $elm$core$Maybe$Just('email'),
		da: false,
		T: $mdgriffith$elm_ui$Element$Input$TextInputNode('email')
	});
...
var $mdgriffith$elm_ui$Element$Input$newPassword = F2(
	function (attrs, pass) {
		return A3(
			...
			{
				bU: $elm$core$Maybe$Just('new-password'),
				da: false,
				T: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.rE ? 'text' : 'password')
			},
			attrs,
			{C: pass.C, bg: pass.bg, bh: pass.bh, bj: pass.bj});
	});
var $author$project$SR$Elements$passwordValidView = function (userInfo) {
	return $author$project$Utils$Validation$Validate$isValid4to8Chars(userInfo.n6) ? A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$SR$Elements$colors.pJ),
...
var $author$project$Pages$Hardware$CancelRegistration = {$: 34};
					...
					[
						...
						_List_fromArray(
							[
								...
								{
									C: $mdgriffith$elm_ui$Element$text('Cancel'),
									as: $elm$core$Maybe$Just($author$project$Pages$Hardware$CancelRegistration)
								}),
								A2(
								$mdgriffith$elm_ui$Element$Input$button,
								_Utils_ap(
								...
								{
									C: $mdgriffith$elm_ui$Element$text('Register'),
									as: $elm$core$Maybe$Just(
								...
								[
											...
											])),
									{
										C: A2(
											...
											$mdgriffith$elm_ui$Element$text('Email*')),
										bg: $author$project$Pages$Hardware$UpdateEmail,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('Email'))),
										bj: A2($elm$core$Maybe$withDefault, '', userInfo.nP)
									}),
									$author$project$Pages$Hardware$emailValidationErr(
									A2($elm$core$Maybe$withDefault, '', userInfo.nP)),
									A2(
											...
											])),
									{
										...
										bg: $author$project$Pages$Hardware$UpdatePassword,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
											...
											])),
									{
										...
										bg: $author$project$Pages$Hardware$UpdateNickName,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
											...
											])),
									{
										...
										bg: $author$project$Pages$Hardware$UpdateLevel,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
											...
											])),
									{
										...
										bg: $author$project$Pages$Hardware$UpdateComment,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
											...
											])),
									{
										C: A2(
											...
											$mdgriffith$elm_ui$Element$text('Mobile \n(inc. Int code\neg.+65)')),
										bg: $author$project$Pages$Hardware$UpdateMobile,
										bh: $elm$core$Maybe$Just(
											A2(
												$mdgriffith$elm_ui$Element$Input$placeholder,
												_List_Nil,
										...
										bj: A2(
											...
											A2($elm$core$Maybe$withDefault, '', userInfo.n0),
											25)
									}),
...
var $author$project$Pages$Hardware$SpectatorJoin = {$: 55};
...
var $author$project$Main$view = function (model) {
	...
	return {
		sZ: _List_fromArray(
			[
				$author$project$Main$pageHeader(model.v),
				$author$project$Main$showVideoOrBanner(model.v),
				contentByPage,
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{un: $author$project$Main$init, u4: $author$project$Main$ChangedUrl, u5: $author$project$Main$ClickedLink, v5: $author$project$Main$subscriptions, wv: $author$project$Main$update, wy: $author$project$Main$view});
