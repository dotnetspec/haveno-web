...
var $author$project$Pages$Accounts$initialModel = {
	...
	listOfExistingCryptoAccounts: _List_Nil,
	newBTCAddress: '',
	pagetitle: 'Accounts',
	primaryaddress: '',
	savedPassword: '',
			...
			_Utils_update(
				model,
				{
					page: $author$project$Main$SellPage(
						_Utils_update(
							sell,
							{listOfExistingCryptoAccounts: model.accountsDataFromJs}))
				}),
		...
		switch (msg.$) {
			...
			case 'ReceivedFromJs':
				...
				if (_v5.$ === 'Ok') {
					var jsMsg = _v5.a;
					var _v6 = jsMsg.page;
					if (_v6.$ === 'AccountsPageJs') {
						var _v7 = jsMsg.typeOfMsg;
						switch (_v7.$) {
							case 'EncryptCryptoAccountMsgRequestJs':
								var _v8 = jsMsg.currency;
								if (_v8.$ === 'BTC') {
									var _v9 = model.page;
									if (_v9.$ === 'AccountsPage') {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$List$isEmpty(model.listOfExistingCryptoAccounts) ? _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('table-scroll-container')
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$id('column-actions')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('')
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Version 0.9.75')
									])),
