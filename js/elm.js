...
var $author$project$Main$msgFromElm = _Platform_outgoingPort('msgFromElm', $elm$json$Json$Encode$string);
var $author$project$Main$gotDecryptedCryptoAccountData = function () {
	...
	return $author$project$Main$msgFromElm(message);
}();
...
var $author$project$Main$JsMessage = F4(
	function (page, typeOfMsg, data, currency) {
		return {currency: currency, data: data, page: page, typeOfMsg: typeOfMsg};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Main$jsMessageDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$JsMessage,
	A2($elm$json$Json$Decode$field, 'page', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'typeOfMsg', $elm$json$Json$Decode$string),
...
var $author$project$Pages$Accounts$DecryptCryptoAccounts = function (a) {
	return {$: 'DecryptCryptoAccounts', a: a};
};
var $author$project$Pages$Accounts$messageDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (msgType) {
		switch (msgType) {
			...
			case 'decryptedCrypoAccountsResponse':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Pages$Accounts$DecryptCryptoAccounts,
	...
	function (msg, model) {
		switch (msg.$) {
			case 'AddNewCryptoAccount':
				var address = msg.a;
				var btcAccountCount = $elm$core$List$length(model.listOfBTCAccounts);
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							listOfBTCAccounts: _Utils_ap(
								model.listOfBTCAccounts,
								_List_fromArray(
									[address]))
						}),
		...
		switch (msg.$) {
			...
			case 'Recv':
				...
				if (_v5.$ === 'Ok') {
					...
					var _v6 = jsMsg.page;
					if (_v6 === 'AccountsPage') {
						var _v7 = A2($elm$json$Json$Decode$decodeValue, $author$project$Pages$Accounts$messageDecoder, jsMsg.data);
						if (_v7.$ === 'Ok') {
							var accountsPageMsgType = _v7.a;
							...
							return A2(
								$author$project$Main$toAccounts,
								model,
								A2($author$project$Pages$Accounts$update, accountsPageMsgType, accountsMdl));
						} else {
							var errmsg = _v7.a;
							return _Utils_Tuple2(
								_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$List$isEmpty(model.listOfBTCAccounts) ? _List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						_List_fromArray(
