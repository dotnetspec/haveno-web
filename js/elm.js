...
var $author$project$Pages$Accounts$AccountsView = {$: 'AccountsView'};
var $author$project$Pages$Accounts$Loading = {$: 'Loading'};
...
var $author$project$Pages$Accounts$initialModel = {
	...
	currentView: $author$project$Pages$Accounts$AccountsView,
	errors: _List_Nil,
	isAddressVisible: false,
	pagetitle: 'Accounts',
	primaryaddress: '',
	status: $author$project$Pages$Accounts$Loading,
	subaddress: ''
};
...
var $author$project$Pages$Connect$init = function (_v0) {
	return _Utils_Tuple2(
		{connectionAttempts: 0, customMoneroNode: '', havenoConnected: false, moneroNode: 'default.node.address:18081', retryingHaveno: false, retryingWallet: false, walletConnected: false},
		$elm$core$Platform$Cmd$none);
};
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$AccountsPage(accounts)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$ConnectPage(connect)
				}),
...
var $author$project$Main$BlankRoute = {$: 'BlankRoute'};
var $author$project$Main$Buy = {$: 'Buy'};
var $author$project$Main$DashboardRoute = {$: 'DashboardRoute'};
...
var $author$project$Main$urlAsPageParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$BlankRoute,
			$elm$url$Url$Parser$s('index.html')),
			A2($elm$url$Url$Parser$map, $author$project$Main$BlankRoute, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$DashboardRoute,
...
var $author$project$Pages$Accounts$ManageAccountsView = {$: 'ManageAccountsView'};
		...
		switch (msg.$) {
			...
			case 'AddNewAccount':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentView: $author$project$Pages$Accounts$ManageAccountsView}),
					$elm$core$Platform$Cmd$none);
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Accounts$AccountsView, primaryaddress: primaryAddresponse.primaryAddress, status: $author$project$Pages$Accounts$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'GotXmrNewSubaddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Accounts$ManageAccountsView, status: $author$project$Pages$Accounts$Loaded, subaddress: subAddresponse.subaddress}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
		...
		switch (msg.$) {
			...
			case 'ConnectionSuccess':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{havenoConnected: true, retryingHaveno: false, retryingWallet: false, walletConnected: true}),
					$elm$core$Platform$Cmd$none);
			case 'ConnectionFailed':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{retryingHaveno: false, retryingWallet: false}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
		...
		switch (msg.$) {
			...
			case 'AddNewAccount':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentView: $author$project$Pages$Donate$ManageDonateView}),
					$elm$core$Platform$Cmd$none);
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					var primaryAddresponse = msg.a.a;
			...
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Funds$FundsView, primaryaddress: primaryAddresponse.primaryAddress, status: $author$project$Pages$Funds$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'GotBalances':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{balances: response.balances, status: $author$project$Pages$Funds$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
		...
		switch (msg.$) {
			...
			case 'GotFundsMsg':
				...
				if (_v9.$ === 'FundsPage') {
					...
					if (fundsMsg.$ === 'ClickedGotNewSubaddress') {
			...
			[
				...
				_List_fromArray(
					[
						...
						(model.isXMRWalletConnected && model.isApiConnected) ? 'status-dot green' : 'status-dot red')
					]),
				_List_Nil),
				$elm$html$Html$text(
				(model.isXMRWalletConnected && model.isApiConnected) ? 'Connected' : ((!model.isXMRWalletConnected) ? 'Wallet not connected' : 'Haveno node not connected')),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
...
var $author$project$Pages$Accounts$AddNewAccount = {$: 'AddNewAccount'};
...
var $author$project$Pages$Connect$GoBack = {$: 'GoBack'};
var $author$project$Pages$Connect$RetryHavenoConnection = {$: 'RetryHavenoConnection'};
var $author$project$Pages$Connect$RetryWalletConnection = {$: 'RetryWalletConnection'};
...
var $author$project$Pages$Funds$ToggleVisibility = {$: 'ToggleVisibility'};
...
var $author$project$Pages$Funds$xmrBalView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Available Balance: ' + ($author$project$Pages$Funds$xmrAvailableBalanceAsString(model.balances) + ' XMR'))
			]));
};
...
var $author$project$Main$view = function (model) {
	var contentByPage = function () {
		...
		switch (_v0.$) {
			...
			default:
				var connectModel = {connectionAttempts: 0, customMoneroNode: '', havenoConnected: model.isApiConnected, moneroNode: 'default.node.address:18081', retryingHaveno: false, retryingWallet: false, walletConnected: model.isXMRWalletConnected};
				return A2(
					$elm$html$Html$map,
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$string)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Proto.Io.Haveno.Protobuffer.GetVersionReply":{"args":[],"type":"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetVersionReply"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetVersionReply":{"args":[],"type":"{ version : String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"},"Proto.Io.Haveno.Protobuffer.GetBalancesReply":{"args":[],"type":"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetBalancesReply"},"Proto.Io.Haveno.Protobuffer.GetXmrNewSubaddressReply":{"args":[],"type":"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetXmrNewSubaddressReply"},"Proto.Io.Haveno.Protobuffer.GetXmrPrimaryAddressReply":{"args":[],"type":"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetXmrPrimaryAddressReply"},"Pages.Dashboard.HavenoAPKHttpRequest":{"args":[],"type":"{ method : String.String, headers : List.List Http.Header, url : String.String, body : Http.Body, timeout : Maybe.Maybe Basics.Float, tracker : Maybe.Maybe String.String }"},"Protobuf.Types.Int64.Int64":{"args":[],"type":"Internal.Int64.Int64"},"Http.Metadata":{"args":[],"type":"{ url : String.String, statusCode : Basics.Int, statusText : String.String, headers : Dict.Dict String.String String.String }"},"Pages.Blank.Model":{"args":[],"type":"{ status : Pages.Blank.Status, title : String.String, root : Pages.Blank.Blank }"},"Pages.Buy.Model":{"args":[],"type":"{ status : Pages.Buy.Status, title : String.String, root : Pages.Buy.Buy }"},"Pages.Dashboard.Model":{"args":[],"type":"{ status : Pages.Dashboard.Status, pagetitle : String.String, root : Pages.Dashboard.Dashboard, balance : String.String, flagUrl : Url.Url, havenoAPKHttpRequest : Maybe.Maybe Pages.Dashboard.HavenoAPKHttpRequest, version : String.String, errors : List.List String.String }"},"Pages.Market.Model":{"args":[],"type":"{ status : Pages.Market.Status, title : String.String, root : Pages.Market.Market }"},"Pages.Portfolio.Model":{"args":[],"type":"{ status : Pages.Portfolio.Status, title : String.String, root : Pages.Portfolio.Portfolio }"},"Pages.Sell.Model":{"args":[],"type":"{ status : Pages.Sell.Status, title : String.String, root : Pages.Sell.Sell }"},"Pages.Support.Model":{"args":[],"type":"{ status : Pages.Support.Status, title : String.String, root : Pages.Support.Support }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__BalancesInfo":{"args":[],"type":"{ btc : Maybe.Maybe Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__BtcBalanceInfo, xmr : Maybe.Maybe Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__XmrBalanceInfo }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__BtcBalanceInfo":{"args":[],"type":"{ availableBalance : Protobuf.Types.Int64.Int64, reservedBalance : Protobuf.Types.Int64.Int64, totalAvailableBalance : Protobuf.Types.Int64.Int64, lockedBalance : Protobuf.Types.Int64.Int64 }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetBalancesReply":{"args":[],"type":"{ balances : Maybe.Maybe Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__BalancesInfo }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetXmrNewSubaddressReply":{"args":[],"type":"{ subaddress : String.String }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__GetXmrPrimaryAddressReply":{"args":[],"type":"{ primaryAddress : String.String }"},"Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__XmrBalanceInfo":{"args":[],"type":"{ balance : Protobuf.Types.Int64.Int64, availableBalance : Protobuf.Types.Int64.Int64, pendingBalance : Protobuf.Types.Int64.Int64, reservedOfferBalance : Protobuf.Types.Int64.Int64, reservedTradeBalance : Protobuf.Types.Int64.Int64 }"},"Pages.Dashboard.SuccessfullBalanceResult":{"args":[],"type":"{ deployment_model : String.String, location : String.String, hostname : String.String, ws_hostname : String.String }"},"Internal.Int64.Ints":{"args":[],"type":"{ higher : Basics.Int, lower : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ClickedLink":["Browser.UrlRequest"],"GotDashboardMsg":["Pages.Dashboard.Msg"],"GotSellMsg":["Pages.Sell.Msg"],"GotBlankMsg":["Pages.Blank.Msg"],"GotPortfolioMsg":["Pages.Portfolio.Msg"],"GotFundsMsg":["Pages.Funds.Msg"],"GotSupportMsg":["Pages.Support.Msg"],"GotBuyMsg":["Pages.Buy.Msg"],"GotMarketMsg":["Pages.Market.Msg"],"GotAccountsMsg":["Pages.Accounts.Msg"],"GotDonateMsg":["Pages.Donate.Msg"],"GotConnectMsg":["Pages.Connect.Msg"],"ChangedUrl":["Url.Url"],"Tick":["Time.Posix"],"AdjustTimeZone":["Time.Zone"],"Recv":["Json.Decode.Value"],"NoOp":[],"GotVersion":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetVersionReply"],"InitComplete":[],"ToggleMenu":[],"RetryWalletConnection":[],"RetryHavenoConnection":[],"SetCustomMoneroNode":["String.String"],"ApplyCustomMoneroNode":["String.String"]}},"Grpc.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["{ metadata : Http.Metadata, response : Bytes.Bytes, errMessage : String.String, status : Grpc.GrpcStatus }"],"BadBody":["Bytes.Bytes"],"UnknownGrpcStatus":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Pages.Accounts.Msg":{"args":[],"tags":{"GotBalances":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetBalancesReply"],"GotXmrPrimaryAddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrPrimaryAddressReply"],"GotXmrNewSubaddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrNewSubaddressReply"],"AddNewAccount":[],"ChangeView":["Pages.Accounts.View"],"ToggleVisibility":[]}},"Pages.Blank.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Blank.Model"]}},"Pages.Buy.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Buy.Model"]}},"Pages.Connect.Msg":{"args":[],"tags":{"RetryWalletConnection":[],"RetryHavenoConnection":[],"SetCustomMoneroNode":["String.String"],"ApplyCustomMoneroNode":[],"ConnectionSuccess":[],"ConnectionFailed":[],"GoBack":[]}},"Pages.Dashboard.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Dashboard.Model"],"BalanceResponse":["Result.Result Http.Error Pages.Dashboard.SuccessfullBalanceResult"]}},"Pages.Donate.Msg":{"args":[],"tags":{"GotBalances":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetBalancesReply"],"GotXmrPrimaryAddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrPrimaryAddressReply"],"GotXmrNewSubaddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrNewSubaddressReply"],"AddNewAccount":[],"ChangeView":["Pages.Donate.View"],"ToggleVisibility":[]}},"Pages.Funds.Msg":{"args":[],"tags":{"GotBalances":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetBalancesReply"],"GotXmrPrimaryAddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrPrimaryAddressReply"],"GotXmrNewSubaddress":["Result.Result Grpc.Error Proto.Io.Haveno.Protobuffer.GetXmrNewSubaddressReply"],"ClickedGotNewSubaddress":[],"ChangeView":["Pages.Funds.View"],"ToggleVisibility":[]}},"Pages.Market.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Market.Model"]}},"Pages.Portfolio.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Portfolio.Model"]}},"Pages.Sell.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Sell.Model"]}},"Pages.Support.Msg":{"args":[],"tags":{"GotInitialModel":["Pages.Support.Model"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"Pages.Blank.Blank":{"args":[],"tags":{"Blank":["{ name : String.String }"]}},"Http.Body":{"args":[],"tags":{"Body":[]}},"Pages.Buy.Buy":{"args":[],"tags":{"Buy":["{ name : String.String }"]}},"Bytes.Bytes":{"args":[],"tags":{"Bytes":[]}},"Pages.Dashboard.Dashboard":{"args":[],"tags":{"Dashboard":["{ name : String.String }"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Grpc.GrpcStatus":{"args":[],"tags":{"Ok_":[],"Cancelled":[],"Unknown":[],"InvalidArgument":[],"DeadlineExceeded":[],"NotFound":[],"AlreadyExists":[],"PermissionDenied":[],"ResourceExhausted":[],"FailedPrecondition":[],"Aborted":[],"OutOfRange":[],"Unimplemented":[],"Internal":[],"Unavailable":[],"DataLoss":[],"Unauthenticated":[]}},"Http.Header":{"args":[],"tags":{"Header":["String.String","String.String"]}},"Internal.Int64.Int64":{"args":[],"tags":{"Int64":["Internal.Int64.Ints"]}},"List.List":{"args":["a"],"tags":{}},"Pages.Market.Market":{"args":[],"tags":{"Market":["{ name : String.String }"]}},"Pages.Portfolio.Portfolio":{"args":[],"tags":{"Portfolio":["{ name : String.String }"]}},"Pages.Sell.Sell":{"args":[],"tags":{"Sell":["{ name : String.String }"]}},"Pages.Blank.Status":{"args":[],"tags":{"Loading":[],"Loaded":[],"Errored":[]}},"Pages.Buy.Status":{"args":[],"tags":{"Loading":[],"Loaded":[],"Errored":[]}},"Pages.Dashboard.Status":{"args":[],"tags":{"Loading":[],"Loaded":[],"Errored":[]}},"Pages.Market.Status":{"args":[],"tags":{"Loading":[]}},"Pages.Portfolio.Status":{"args":[],"tags":{"Loading":[]}},"Pages.Sell.Status":{"args":[],"tags":{"Loading":[]}},"Pages.Support.Status":{"args":[],"tags":{"Loading":[]}},"Pages.Support.Support":{"args":[],"tags":{"Support":["{ name : String.String }"]}},"Pages.Accounts.View":{"args":[],"tags":{"AccountsView":[],"ErrorView":[],"ManageAccountsView":[]}},"Pages.Donate.View":{"args":[],"tags":{"DonateView":[],"ErrorView":[],"ManageDonateView":[]}},"Pages.Funds.View":{"args":[],"tags":{"FundsView":[],"ErrorView":[],"SubAddressView":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));