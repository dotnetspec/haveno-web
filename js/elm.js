			...
			case 'DecryptCryptoAccounts':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							listOfBTCAccounts: _Utils_ap(model.listOfBTCAccounts, data)
						}),
					$elm$core$Platform$Cmd$none);
		...
		switch (msg.$) {
			...
			case 'Recv':
				...
				var _v5 = A2(
					$elm$core$Debug$log,
					'message',
					A2($elm$json$Json$Encode$encode, 2, message));
						...
						switch (_v8) {
							case 'encryptCrypoAccountMsgRequest':
								var accountsMdl = function () {
									...
									if (_v9.$ === 'AccountsPage') {
										...
										return _Utils_update(
											accountsModel,
											{listOfBTCAccounts: jsMsg.accountsData});
									} else {
							...
							case 'decryptedCrypoAccountsResponse':
								...
								return A2(
									...
									A2(
										$author$project$Pages$Accounts$update,
										$author$project$Pages$Accounts$DecryptCryptoAccounts(jsMsg.accountsData),
										accountsMdl));
							default:
								return _Utils_Tuple2(
									_Utils_update(
			...
			case 'GotAccountsMsg':
				...
				var _v19 = model.page;
				if (_v19.$ === 'AccountsPage') {
					var accountsModel = _v19.a;
					var _v20 = A2($author$project$Pages$Accounts$update, accountsMsg, accountsModel);
					var updatedAccountsModel = _v20.a;
					var accountsCmd = _v20.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
