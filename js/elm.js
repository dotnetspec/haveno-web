...
var $author$project$Pages$Wallet$Loading = {$: 'Loading'};
var $author$project$Pages$Wallet$WalletView = {$: 'WalletView'};
...
var $author$project$Pages$Wallet$initialModel = {
	...
	currentView: $author$project$Pages$Wallet$WalletView,
	errors: _List_Nil,
	pagetitle: 'Haveno Web Wallet',
	primaryaddress: '',
	status: $author$project$Pages$Wallet$Loading,
	subaddress: ''
};
...
var $author$project$Main$toWallet = F2(
	function (model, _v0) {
		...
		var newWalletModel = _Utils_update(
			wallet,
			{primaryaddress: model.xmrWalletAddress});
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$WalletPage(newWalletModel)
				}),
...
var $author$project$Main$WalletRoute = {$: 'WalletRoute'};
...
var $author$project$Main$urlAsPageParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$WalletRoute,
...
var $author$project$Pages$Wallet$SubAddressView = {$: 'SubAddressView'};
			...
			case 'GotXmrPrimaryAddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Wallet$WalletView, primaryaddress: primaryAddresponse.primaryAddress, status: $author$project$Pages$Wallet$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'GotXmrNewSubaddress':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentView: $author$project$Pages$Wallet$SubAddressView, status: $author$project$Pages$Wallet$Loaded, subaddress: subAddresponse.subaddress}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'GotBalances':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{balances: response.balances, status: $author$project$Pages$Wallet$Loaded}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'GotVersion':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{isApiConnected: false, isPopUpVisible: false, version: 'Error obtaining version'}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Recv':
			...
			case 'GotWalletMsg':
				...
				if (_v13.$ === 'WalletPage') {
					...
					if (walletMsg.$ === 'ClickedGotNewSubaddress') {
						var newWalletModel = _Utils_update(
							wallet,
							{currentView: $author$project$Pages$Wallet$SubAddressView, status: $author$project$Pages$Wallet$Loaded});
						return A2(
							$author$project$Main$toWallet,
							model,
							...
							[
								...
								_List_fromArray(
									[
										...
										model.isApiConnected ? 'indicator green' : (model.isPopUpVisible ? 'indicator white' : 'indicator red')),
										$elm$html$Html$Attributes$id('apiConnectionStatus')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										model.isApiConnected ? '✔' : (model.isPopUpVisible ? '_' : '✖'))
									]))
							]))
					]))
			]));
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class(
										(!(model.xmrWalletAddress === '')) ? 'indicator green' : (model.isPopUpVisible ? 'indicator white' : 'indicator red')),
										$elm$html$Html$Attributes$id('xmraddressreceived')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										(!(model.xmrWalletAddress === '')) ? '✔' : (model.isPopUpVisible ? '_' : '✖'))
									]))
							]))
					]))
			]));
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class(
										model.isHardwareDeviceConnected ? 'indicator green' : (model.isPopUpVisible ? 'indicator white' : 'indicator red')),
										$elm$html$Html$Attributes$id('hwdeviceconnection')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										model.isHardwareDeviceConnected ? '✔' : (model.isPopUpVisible ? '_' : '✖'))
									]))
							]))
					]))
			]));
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class(
										model.isXMRWalletConnected ? 'indicator green' : (model.isPopUpVisible ? 'indicator white' : 'indicator red')),
										$elm$html$Html$Attributes$id('xmrwalletconnection')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										model.isXMRWalletConnected ? '✔' : (model.isPopUpVisible ? '_' : '✖'))
									]))
							]))
					]))
			]));
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						model.isMenuOpen ? 'Close Menu' : 'Open Menu')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Pages$Wallet$ClickedGotNewSubaddress = {$: 'ClickedGotNewSubaddress'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Current address: ' + model.primaryaddress)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
									...
									_List_fromArray(
										[
											...
											switch (_v1.$) {
												...
												case 'SubAddressView':
													return $author$project$Pages$Wallet$subAddressView(model.subaddress);
												default:
