...
#Following starts the Envoy proxy in haveno-ts
...
# -- WARN: Using test application?  Go to ~/Documents/Development/Monero/haveno-dex/haveno-ui and run 'yarn watch'
gnome-terminal -- bash -c "cd ~/Documents/Development/Monero/haveno-dex/haveno-ui && yarn watch; exec bash"
