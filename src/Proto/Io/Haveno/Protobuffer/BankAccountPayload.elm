...
module Proto.Io.Haveno.Protobuffer.BankAccountPayload exposing (Message)
...
-}
type alias Message =
    Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__BankAccountPayload__Message__Message
