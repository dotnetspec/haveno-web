...
module Proto.Io.Haveno.Protobuffer.CountryBasedPaymentAccountPayload exposing (Message)
...
-}
type alias Message =
    Proto.Io.Haveno.Protobuffer.Internals_.Proto__Io__Haveno__Protobuffer__CountryBasedPaymentAccountPayload__Message__Message
