...
var $savardd$elm_time_travel$TimeTravel$Internal$InlineHover$enterEach = function (_v0) {
	var key = _v0.a;
	var value = _v0.b;
...
var $savardd$elm_time_travel$TimeTravel$Internal$InlineHover$leaveEach = function (_v0) {
	var key = _v0.a;
	var value = _v0.b;
	var keyCamel = $savardd$elm_time_travel$TimeTravel$Internal$InlineHover$toCamelCase(key);
	...
	function (s, list) {
		...
		while (true) {
			if (!list.b) {
				...
				var ast = list.a;
				var tail = list.b;
				var _v1 = A2($savardd$elm_time_travel$TimeTravel$Internal$Parser$AST$filterByExactId, s, ast);
				if (_v1.$ === 'Nothing') {
					var $temp$s = s,
						$temp$list = tail;
					s = $temp$s;
		...
		if ((lazyModelAst.$ === 'Just') && (lazyModelAst.a.$ === 'Ok')) {
			...
			var filteredAst = function () {
				if (A2($elm$core$String$startsWith, '@', modelFilter)) {
					var _v2 = A2($savardd$elm_time_travel$TimeTravel$Internal$Parser$AST$filterByExactId, modelFilter, ast);
					if (_v2.$ === 'Just') {
						var x = _v2.a;
						return _List_fromArray(
							[
...
var $savardd$elm_time_travel$TimeTravel$Internal$Util$Nel$toList = function (_v0) {
	var head_ = _v0.a;
	var tail = _v0.b;
...
var $savardd$elm_time_travel$TimeTravel$Internal$Util$Nel$head = function (_v0) {
	var head_ = _v0.a;
	var tail = _v0.b;
	return head_;
};
var $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedItem = function (model) {
	var _v0 = _Utils_Tuple2(model.sync, model.selectedMsg);
	if (_v0.a) {
		return $elm$core$Maybe$Just(
...
var $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedMsgAst = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		var _v1 = A2(
			...
			model.history);
		if (((_v1.$ === 'Just') && (_v1.a.$ === 'Just')) && (_v1.a.a.$ === 'Ok')) {
			var ast = _v1.a.a.a;
			return $elm$core$Maybe$Just(ast);
		} else {
			return $elm$core$Maybe$Nothing;
...
var $savardd$elm_time_travel$TimeTravel$Internal$Util$RTree$addChildAt = F3(
	function (f, _new, tree) {
		...
		var a = _v0.a;
		var list = _v0.b;
		var _v1 = f(a) ? A2($savardd$elm_time_travel$TimeTravel$Internal$Util$RTree$addChild, _new, tree) : tree;
		var a_ = _v1.a;
		var list_ = _v1.b;
		return A2(
			$savardd$elm_time_travel$TimeTravel$Internal$Util$RTree$Node,
...
var $savardd$elm_time_travel$TimeTravel$Internal$Util$RTree$root = function (_v0) {
	var a = _v0.a;
	var list = _v0.b;
	return a;
};
...
var $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedMsgTree = function (model) {
	...
	if (_v0.$ === 'Just') {
		var id = _v0.a;
		var _v1 = A2($savardd$elm_time_travel$TimeTravel$Internal$Model$msgRootOf, id, model.history);
		if (_v1.$ === 'Just') {
			var root = _v1.a;
			var f = F2(
				function (item, tree) {
...
var $savardd$elm_time_travel$TimeTravel$Internal$MsgTreeView$viewTree = F5(
	function (config, onSelect, indent, selectedMsg, _v0) {
		var item = _v0.a;
		var list = _v0.b;
		return A2(
			$elm$core$List$cons,
	...
	function (config, model) {
		if (!model.sync) {
			...
			var diffView = function () {
				var _v2 = $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedItem(model);
				if (_v2.$ === 'Just') {
					var item = _v2.a;
					var _v3 = item.lazyDiff;
					if (_v3.$ === 'Just') {
						var changes = _v3.a;
			...
			var detailedMsgView = function () {
				var _v1 = $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedMsgAst(model);
				if (_v1.$ === 'Just') {
					var ast = _v1.a;
					return A2(
						$elm$html$Html$div,
			...
			var body = function () {
				if (model.showModelDetail) {
					var _v0 = $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedItem(model);
					if (_v0.$ === 'Just') {
						var item = _v0.a;
						return _List_fromArray(
							[
...
var $savardd$elm_time_travel$TimeTravel$Internal$View$filterItemView = function (_v0) {
	var name = _v0.a;
	var visible = _v0.b;
	return A2(
		$elm$html$Html$div,
...
var $savardd$elm_time_travel$TimeTravel$Internal$View$msgView = F4(
	function (config, filterOptions, selectedMsg, _v0) {
		var id = _v0.id;
		var msg = _v0.msg;
		var causedBy = _v0.causedBy;
		...
		var visible = _Utils_eq(msg, $savardd$elm_time_travel$TimeTravel$Internal$MsgLike$Init) || function () {
			var _v2 = $elm$core$String$words(str);
			if (_v2.b) {
				var tag = _v2.a;
				return A2(
					$elm$core$List$any,
...
var $savardd$elm_time_travel$TimeTravel$Internal$View$watchView = function (model) {
	...
	if (((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) && (_v0.b.a.$ === 'Ok')) {
		var id = _v0.a.a;
		var ast = _v0.b.a.a;
		var treeView = function () {
			var _v1 = A2($savardd$elm_time_travel$TimeTravel$Internal$Parser$AST$filterByExactId, id, ast);
			if (_v1.$ === 'Just') {
				var ast_ = _v1.a;
...
var $savardd$elm_time_travel$TimeTravel$Internal$View$view = F5(
	function (config, transformUserMsg, transformDebuggerMsg, userViewFunc, model) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
...
var $savardd$elm_time_travel$TimeTravel$Internal$Model$encodeTuple = F3(
	function (aEncoder, bEncoder, _v0) {
		var a = _v0.a;
		var b = _v0.b;
		return A2(
			$elm$json$Json$Encode$list,
							...
							A2(
								...
								A2(
									...
									A2(
										$andre_dietrich$parser_combinators$Combine$map,
										F7(
											function (_v6, key, _v7, _v8, _v9, value, _v10) {
...
var $savardd$elm_time_travel$TimeTravel$Internal$Model$updateLazyDiffHelp = F2(
	function (model, item) {
		var newDiff = function () {
			var _v0 = item.lazyDiff;
			if (_v0.$ === 'Just') {
				var changes = _v0.a;
				return $elm$core$Maybe$Just(changes);
			} else {
				var _v1 = $savardd$elm_time_travel$TimeTravel$Internal$Model$selectedAndOldAst(model);
				if (_v1.$ === 'Just') {
					var _v2 = _v1.a;
					var oldAst = _v2.a;
					var newAst = _v2.b;
		...
		switch (message.$) {
			case 'Receive':
				...
				if (incomingMsg.type_ === 'load') {
					var _v1 = $savardd$elm_time_travel$TimeTravel$Internal$Model$decodeSettings(incomingMsg.settings);
					if (_v1.$ === 'Ok') {
						var fixedToLeft = _v1.a.fixedToLeft;
						var filter = _v1.a.filter;
						return _Utils_Tuple2(
							_Utils_update(
								model,
...
var $savardd$elm_time_travel$TimeTravel$Internal$Model$updateOnIncomingUserMsg = F5(
	function (config, transformMsg, update, _v0, model) {
		var causedBy = _v0.a;
		var msg = _v0.b;
		var megLike = $savardd$elm_time_travel$TimeTravel$Internal$MsgLike$Message(msg);
		var _v1 = model.history;
		var last = _v1.a;
		var past = _v1.b;
		var _v2 = A2(update, msg, last.model);
		var newRawUserModel = _v2.a;
		var userCmd = _v2.b;
...
var $savardd$elm_time_travel$TimeTravel$Browser$wrapUpdate = F5(
	function (config, update, outgoingMsg, msg, model) {
		var toUserMessage = function (_v4) {
			var id_ = _v4.a;
			var msg_ = _v4.b;
			return $savardd$elm_time_travel$TimeTravel$Browser$UserMsg(
				_Utils_Tuple2(
		...
		if (msg.$ === 'UserMsg') {
			var msgWithId = msg.a;
			var _v1 = A5($savardd$elm_time_travel$TimeTravel$Internal$Model$updateOnIncomingUserMsg, config, toUserMessage, update, msgWithId, model);
			var m = _v1.a;
			var c1 = _v1.b;
			var _v2 = A2($savardd$elm_time_travel$TimeTravel$Internal$Update$updateAfterUserMsg, outgoingMsg, m);
			var m_ = _v2.a;
			var c2 = _v2.b;
			return _Utils_Tuple2(
				m_,
			...
			var msg_ = msg.a;
			var _v3 = A4($savardd$elm_time_travel$TimeTravel$Internal$Update$update, config, outgoingMsg, msg_, model);
			var m = _v3.a;
			var c = _v3.b;
			return _Utils_Tuple2(
				m,
...
var $savardd$elm_time_travel$TimeTravel$Browser$wrap = F2(
	function (_v0, _v1) {
		var outgoingMsg = _v0.outgoingMsg;
		var incomingMsg = _v0.incomingMsg;
		var config = _v0.config;
		var init = _v1.init;
		var view = _v1.view;
		var update = _v1.update;
		var subscriptions = _v1.subscriptions;
...
var $savardd$elm_time_travel$TimeTravel$Browser$element = F4(
	function (modelToString, msgToString, config, _v0) {
		var init = _v0.init;
		var view = _v0.view;
...
var $author$project$Main$AppOps = function (a) {
	return {$: 'AppOps', a: a};
};
var $author$project$Main$Login = function (a) {
	return {$: 'Login', a: a};
};
var $author$project$Main$emptyEmailPasswordLogin = {email: '', password: ''};
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		$author$project$Main$AppOps(
			$author$project$Main$Login($author$project$Main$emptyEmailPasswordLogin)),
		$elm$core$Platform$Cmd$none);
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'nickname',
					$elm$json$Json$Encode$string('temp string')),
					_Utils_Tuple2(
					'userid',
					$elm$json$Json$Encode$string('temp string'))
				]));
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'nickname',
					$elm$json$Json$Encode$string('nickname failure err')),
					_Utils_Tuple2(
					'userid',
					$elm$json$Json$Encode$string('userid failure err'))
				]));
	}
};
var $author$project$Main$setStorage = _Platform_outgoingPort('setStorage', $elm$core$Basics$identity);
var $author$project$Data$Ranking$Both = {$: 'Both'};
var $author$project$Data$Ranking$ConfirmResult = function (a) {
	return {$: 'ConfirmResult', a: a};
};
var $author$project$Data$Ranking$CreateChallenge = function (a) {
	return {$: 'CreateChallenge', a: a};
};
var $author$project$Data$Ranking$CreateResult = function (a) {
	return {$: 'CreateResult', a: a};
};
var $author$project$Main$Fetched = F2(
	function (a, b) {
		return {$: 'Fetched', a: a, b: b};
	});
var $author$project$Main$Global = function (a) {
	return {$: 'Global', a: a};
};
var $author$project$Data$Ranking$Ladder = F2(
	function (a, b) {
		return {$: 'Ladder', a: a, b: b};
	});
...
var $author$project$Data$Ranking$View = {$: 'View'};
var $author$project$Data$Ranking$Won = function (a) {
	return {$: 'Won', a: a};
};
...
var $author$project$Main$fetchedMemberRanking = function (ranking) {
	return $author$project$Main$sendMessage('fetchRanking, ' + ranking.id);
};
var $author$project$Main$fetchedOwnedRanking = function (ranking) {
	return $author$project$Main$sendMessage('fetchRanking, ' + ranking.id);
};
var $author$project$Main$handleCancel = F2(
	function (msg, model) {
		...
		while (true) {
			if (_v0.a.$ === 'Cancel') {
				if (_v0.b.$ === 'AppOps') {
												...
												$author$project$Main$AppOps(
													A2(
														...
														$author$project$Main$Global(
															A2($author$project$Data$Ranking$Ladder, $author$project$Data$Ranking$Both, $author$project$Data$Ranking$View)))),
												$elm$core$Platform$Cmd$none);
										} else {
											break _v0$9;
										}
											...
											$author$project$Main$AppOps(
												A2(
													...
													$author$project$Main$Selected(
														A2($author$project$Data$Ranking$Ladder, l, $author$project$Data$Ranking$View)))),
											$elm$core$Platform$Cmd$none);
									case 'CreateResult':
										var _v24 = _v0.a;
										var _v25 = _v0.b.a;
					...
					var errMsg = _v0.b.a;
					return _Utils_Tuple2(
						$author$project$Main$Failure('Error : ' + errMsg),
						$elm$core$Platform$Cmd$none);
				}
			} else {
				break _v0$9;
		...
		return _Utils_Tuple2(
			$author$project$Main$Failure('Cancel fell thru ... '),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$Loading = function (a) {
	return {$: 'Loading', a: a};
};
var $author$project$Main$sendRanking = F2(
	function (userInfo, ranking) {
		return $author$project$Main$sendMessage('createRanking, ' + (userInfo.email + (',' + (userInfo.password + (',' + (userInfo.nickname + (',' + (ranking.name + (',' + (ranking.baseaddress.street + (',' + ranking.baseaddress.city)))))))))));
	});
var $author$project$Main$sendRegister = function (user) {
	if (user.$ === 'Spectator') {
		var _v1 = user.a;
		var userInfo = _v1.a;
		return $author$project$Main$sendMessage('register, ' + (userInfo.email + (',' + (userInfo.password + (',' + userInfo.nickname)))));
	} else {
		var _v2 = user.a;
		return $elm$core$Platform$Cmd$none;
	}
};
var $author$project$Main$handleConfirm = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$3:
		while (true) {
			if ((_v0.a.$ === 'Confirm') && (_v0.b.$ === 'AppOps')) {
				switch (_v0.b.a.$) {
					case 'RegisSpectator':
						var _v1 = _v0.a;
						var user = _v0.b.a.a;
						return _Utils_Tuple2(
							$author$project$Main$AppOps(
								$author$project$Main$Loading(
									$author$project$Main$Global(
										A2($author$project$Data$Ranking$Ladder, $author$project$Data$Ranking$Both, $author$project$Data$Ranking$View)))),
							$author$project$Main$sendRegister(user));
					case 'Fetched':
						if (_v0.b.a.b.$ === 'Global') {
							if ((((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'View')) && (_v0.b.a.b.a.a.$ === 'Owned')) && (_v0.b.a.b.a.b.$ === 'Create')) {
								var _v2 = _v0.a;
								var _v3 = _v0.b.a;
								var _v4 = _v3.a.a;
								var userInfo = _v4.a;
								...
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$Loading(
											$author$project$Main$Global(
												A2($author$project$Data$Ranking$Ladder, $author$project$Data$Ranking$Both, $author$project$Data$Ranking$View)))),
									A2($author$project$Main$sendRanking, userInfo, ranking));
							} else {
								break _v0$3;
							}
						} else {
							if (_v0.b.a.b.a.b.$ === 'ConfirmResult') {
								var _v8 = _v0.a;
								var _v9 = _v0.b.a;
								var u = _v9.a;
								var _v10 = _v9.b.a;
		...
		return _Utils_Tuple2(
			$author$project$Main$Failure('Confirm fell thru ... '),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Data$User$AppUser = F2(
	function (a, b) {
		return {$: 'AppUser', a: a, b: b};
	});
var $author$project$Data$Ranking$Create = {$: 'Create'};
var $author$project$Data$User$Create = {$: 'Create'};
var $author$project$Main$RegisSpectator = function (a) {
	return {$: 'RegisSpectator', a: a};
};
...
var $author$project$Data$User$View = {$: 'View'};
										...
										return function (description) {
											return function (mobile) {
												return function (credits) {
													return {active: active, credits: credits, datestamp: datestamp, description: description, email: email, memberRankings: memberRankings, mobile: mobile, nickname: nickname, ownedRankings: ownedRankings, password: password, token: token, updatetext: updatetext, userid: userid};
												};
											};
										};
									};
...
var $author$project$Data$User$emptyUserInfo = $author$project$Data$User$UserInfo('')('')('')($elm$core$Maybe$Nothing)('Anon')(0)(true)(_List_Nil)(_List_Nil)('')($author$project$Data$User$emptyDescription)('')(0);
var $author$project$Data$User$emptySpectator = $author$project$Data$User$Spectator(
	A2($author$project$Data$User$AppUser, $author$project$Data$User$emptyUserInfo, $author$project$Data$User$View));
var $author$project$Main$handleCreate = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$3:
		while (true) {
			if ((_v0.a.$ === 'Create') && (_v0.b.$ === 'AppOps')) {
				switch (_v0.b.a.$) {
					case 'Login':
						var _v8 = _v0.a;
						return _Utils_Tuple2(
							$author$project$Main$AppOps(
								$author$project$Main$RegisSpectator(
									$author$project$Data$User$Spectator(
										A2($author$project$Data$User$AppUser, $author$project$Data$User$emptyUserInfo, $author$project$Data$User$Create)))),
							$elm$core$Platform$Cmd$none);
					case 'Fetched':
						if (_v0.b.a.a.$ === 'Registered') {
							if ((((_v0.b.a.a.a.b.$ === 'View') && (_v0.b.a.b.$ === 'Global')) && (_v0.b.a.b.a.a.$ === 'Both')) && (_v0.b.a.b.a.b.$ === 'View')) {
								var _v1 = _v0.a;
								var _v2 = _v0.b.a;
								var _v3 = _v2.a.a;
								var userInfo = _v3.a;
								...
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										A2(
											$author$project$Main$Fetched,
											$author$project$Data$User$Registered(
												A2($author$project$Data$User$AppUser, userInfo, $author$project$Data$User$View)),
											$author$project$Main$Global(
												A2(
													$author$project$Data$Ranking$Ladder,
													$author$project$Data$Ranking$Owned($author$project$Data$Ranking$emptyRanking),
													$author$project$Data$Ranking$Create)))),
									$elm$core$Platform$Cmd$none);
							} else {
								break _v0$3;
							}
							...
							return _Utils_Tuple2(
								$author$project$Main$AppOps(
									$author$project$Main$RegisSpectator($author$project$Data$User$emptySpectator)),
								$elm$core$Platform$Cmd$none);
						}
					default:
						break _v0$3;
		...
		return _Utils_Tuple2(
			$author$project$Main$Failure('Create ... will fall thru to View Failure '),
			$elm$core$Platform$Cmd$none);
	});
var $elm$core$Debug$log = _Debug_log;
var $author$project$Data$Ranking$Ranking = F8(
	function (id, active, name, owner_id, baseaddress, ranking, player_count, owner_name) {
		return {active: active, baseaddress: baseaddress, id: id, name: name, owner_id: owner_id, owner_name: owner_name, player_count: player_count, ranking: ranking};
	});
...
var $author$project$Main$handleDecodeRanking = function (rawJsonMessage) {
	var decodedJsonMsg = A2($elm$json$Json$Decode$decodeValue, $author$project$Data$Ranking$rankingDecoder, rawJsonMessage);
	var _v0 = A2(
		$elm$core$Debug$log,
		'RF: maybe can fix rawjson here (not in js)? : ',
		A2($elm$json$Json$Encode$encode, 2, rawJsonMessage));
	if (decodedJsonMsg.$ === 'Ok') {
		var decodedRanking = decodedJsonMsg.a;
		return decodedRanking;
	} else {
...
var $author$project$Data$User$userForDecoder = function (userid) {
	return function (email) {
		return function (password) {
			return function (token) {
				return function (nickname) {
											...
											return function (mobile) {
												return function (credits) {
													return $author$project$Data$User$Registered(
														A2(
															$author$project$Data$User$AppUser,
															$author$project$Data$User$UserInfo(userid)(email)(password)(token)(nickname)(datestamp)(active)(ownedrankings)(memberrankings)(updatetext)(desc)(mobile)(credits),
															$author$project$Data$User$View));
												};
											};
										};
									};
...
var $author$project$Data$User$OwnedRanking = F2(
	function (id, name) {
		return {id: id, name: name};
	});
var $author$project$Data$User$userRankingsDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'name',
	$elm$json$Json$Decode$string,
	A3(
		...
		'_id',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Data$User$OwnedRanking)));
		...
		A3(
			...
			A3(
				...
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'memberRankings',
					$elm$json$Json$Decode$list($author$project$Data$User$userRankingsDecoder),
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'ownedRankings',
						$elm$json$Json$Decode$list($author$project$Data$User$userRankingsDecoder),
										...
										A3(
											...
											A3(
												...
												A3(
													...
													'userid',
													$elm$json$Json$Decode$string,
													$elm$json$Json$Decode$succeed($author$project$Data$User$userForDecoder))))))))))))));
var $author$project$Main$handleDecodeUser = function (rawJsonMessage) {
	var decodedJsonMsg = A2($elm$json$Json$Decode$decodeValue, $author$project$Data$User$userDecoder, rawJsonMessage);
	if (decodedJsonMsg.$ === 'Ok') {
		var decodedUser = decodedJsonMsg.a;
		var _v1 = A2($elm$core$Debug$log, 'decodedUser', decodedUser);
		return $author$project$Main$AppOps(
			A2(
				$author$project$Main$Fetched,
				decodedUser,
				$author$project$Main$Global(
...
var $author$project$Main$handleDelete = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		return _Utils_Tuple2(
			$author$project$Main$Failure('Cancel fell thru ... '),
...
var $author$project$Main$handleRankingUpdate = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$4:
		while (true) {
			if ((((_v0.b.$ === 'AppOps') && (_v0.b.a.$ === 'Fetched')) && (_v0.b.a.b.$ === 'Global')) && (_v0.b.a.b.a.b.$ === 'Create')) {
				switch (_v0.b.a.b.a.a.$) {
					case 'Both':
						if (_v0.a.$ === 'RankingNameChg') {
							var _v1 = _v0.b.a;
							var user = _v1.a;
							var _v2 = _v1.b.a;
							var _v3 = _v2.a;
									...
									$author$project$Main$AppOps(
										A2(
											...
											$author$project$Main$Global(
												A2(
													$author$project$Data$Ranking$Ladder,
													$author$project$Data$Ranking$Owned(
														A2($author$project$Data$Ranking$updatedRankingName, ranking, updateField)),
													$author$project$Data$Ranking$Create)))),
									$elm$core$Platform$Cmd$none);
										...
										A2(
											...
											$author$project$Main$Global(
												A2(
													$author$project$Data$Ranking$Ladder,
													$author$project$Data$Ranking$Owned(
														A2($author$project$Data$Ranking$updatedStreet, ranking, updateField)),
													$author$project$Data$Ranking$Create)))),
									$elm$core$Platform$Cmd$none);
							case 'CityAddressChg':
								var updateField = _v0.a.a;
										...
										A2(
											...
											$author$project$Main$Global(
												A2(
													$author$project$Data$Ranking$Ladder,
													$author$project$Data$Ranking$Owned(
														A2($author$project$Data$Ranking$updatedCity, ranking, updateField)),
													$author$project$Data$Ranking$Create)))),
									$elm$core$Platform$Cmd$none);
							default:
								break _v0$4;
		...
		return _Utils_Tuple2(
			$author$project$Main$Failure('User update fell thru -> to View Failure '),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Data$User$gotDescriptionFromUser = function (user) {
	if (user.$ === 'Spectator') {
		var _v1 = user.a;
		var userInfo = _v1.a;
...
var $author$project$Data$User$updatedComment = F2(
	function (user, comment) {
		var desc = $author$project$Data$User$gotDescriptionFromUser(user);
		...
		if (user.$ === 'Spectator') {
			...
			var userInfo = _v1.a;
			var admin = _v1.b;
			return $author$project$Data$User$Spectator(
				A2(
					$author$project$Data$User$AppUser,
					_Utils_update(
						userInfo,
...
var $author$project$Data$User$updatedEmail = F2(
	function (user, str) {
		if (user.$ === 'Spectator') {
			var _v1 = user.a;
			var userInfo = _v1.a;
...
var $author$project$Data$User$updatedLevel = F2(
	function (user, level) {
		var desc = $author$project$Data$User$gotDescriptionFromUser(user);
		var newDesc = _Utils_update(
			desc,
...
var $author$project$Data$User$updatedMobile = F2(
	function (user, str) {
		if (user.$ === 'Spectator') {
			var _v1 = user.a;
			var userInfo = _v1.a;
...
var $author$project$Data$User$updatedNickName = F2(
	function (user, str) {
		if (user.$ === 'Spectator') {
			var _v1 = user.a;
			var userInfo = _v1.a;
...
var $author$project$Data$User$updatedPassword = F2(
	function (user, str) {
		if (user.$ === 'Spectator') {
			var _v1 = user.a;
			var userInfo = _v1.a;
...
var $author$project$Main$handleUserUpdate = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$12:
		while (true) {
						...
						switch (_v0.a.$) {
							case 'EmailChg':
								...
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedEmail, user, updateField))),
									$elm$core$Platform$Cmd$none);
							case 'PwdChg':
								var updateField = _v0.a.a;
								var user = _v0.b.a.a;
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedPassword, user, updateField))),
									$elm$core$Platform$Cmd$none);
							case 'NickNameChg':
								var updateField = _v0.a.a;
								var user = _v0.b.a.a;
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedNickName, user, updateField))),
									$elm$core$Platform$Cmd$none);
							case 'DescLevelChg':
								var updateField = _v0.a.a;
								var user = _v0.b.a.a;
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedLevel, user, updateField))),
									$elm$core$Platform$Cmd$none);
							case 'DescCommentChg':
								var updateField = _v0.a.a;
								var user = _v0.b.a.a;
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedComment, user, updateField))),
									$elm$core$Platform$Cmd$none);
							case 'MobileChg':
								var updateField = _v0.a.a;
								var user = _v0.b.a.a;
								return _Utils_Tuple2(
									$author$project$Main$AppOps(
										$author$project$Main$RegisSpectator(
											A2($author$project$Data$User$updatedMobile, user, updateField))),
									$elm$core$Platform$Cmd$none);
							default:
								break _v0$12;
						}
		...
		return _Utils_Tuple2(
			$author$project$Main$Failure('User update fell thru ... '),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$handleView = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		if (_v0.a.$ === 'View') {
			var _v1 = _v0.a;
			...
			return _Utils_Tuple2(
				$author$project$Main$Failure('Create fell thru ... '),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$loginUser = F2(
	function (email, password) {
		return $author$project$Main$sendMessage('login' + (',' + (email + (',' + password))));
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
					...
					while (true) {
						...
						while (true) {
							switch (_v0.a.$) {
								case 'ClickedLogInUser':
									if (_v0.b.$ === 'AppOps') {
										switch (_v0.b.a.$) {
											case 'Login':
												var _v1 = _v0.a;
												var emailpword = _v0.b.a.a;
												return _Utils_Tuple2(
													$author$project$Main$AppOps(
														$author$project$Main$Login(emailpword)),
													A2($author$project$Main$loginUser, 't1@t.com', 'Pa55w0rd'));
											case 'RegisSpectator':
												if ((_v0.b.a.a.$ === 'Spectator') && (_v0.b.a.a.a.b.$ === 'Create')) {
													break _v0$19;
												} else {
													break _v0$23;
												}
											case 'Fetched':
												if ((_v0.b.a.b.$ === 'Global') && (_v0.b.a.b.a.b.$ === 'Create')) {
													switch (_v0.b.a.b.a.a.$) {
														case 'Both':
															if ((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'Create')) {
																break _v0$20;
															} else {
																break _v0$21;
															}
								...
								case 'View':
									var _v4 = _v0.a;
									return A2($author$project$Main$handleView, msg, model);
								case 'Create':
									var _v5 = _v0.a;
									return A2($author$project$Main$handleCreate, msg, model);
								case 'Confirm':
									var _v6 = _v0.a;
									return A2($author$project$Main$handleConfirm, msg, model);
								case 'Cancel':
									if (_v0.b.$ === 'Failure') {
										var _v7 = _v0.a;
										var failMsg = _v0.b.a;
										return A2($author$project$Main$handleCancel, msg, model);
									} else {
										switch (_v0.b.a.$) {
											case 'RegisSpectator':
												if ((_v0.b.a.a.$ === 'Spectator') && (_v0.b.a.a.a.b.$ === 'Create')) {
								...
								case 'Delete':
									var _v8 = _v0.a;
									return A2($author$project$Main$handleDelete, msg, model);
								case 'ViewOwned':
									if (_v0.b.$ === 'AppOps') {
										switch (_v0.b.a.$) {
											case 'RegisSpectator':
															...
															A2(
																...
																$author$project$Main$Selected(
																	A2(
																		$author$project$Data$Ranking$Ladder,
																		$author$project$Data$Ranking$Owned($author$project$Data$Ranking$emptyRanking),
																		$author$project$Data$Ranking$View)))),
														$author$project$Main$fetchedOwnedRanking(ownedranking));
												} else {
													if ((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'Create')) {
														break _v0$20;
													} else {
														...
														$author$project$Main$AppOps(
															A2(
																...
																$author$project$Main$Selected(
																	A2(
																		$author$project$Data$Ranking$Ladder,
																		$author$project$Data$Ranking$Member($author$project$Data$Ranking$emptyRanking),
																		$author$project$Data$Ranking$View)))),
														$author$project$Main$fetchedMemberRanking(ranking));
												} else {
													if ((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'Create')) {
														break _v0$20;
													} else {
								...
								case 'ViewRank':
									if (_v0.b.$ === 'AppOps') {
										switch (_v0.b.a.$) {
											...
											case 'Fetched':
												if (_v0.b.a.b.$ === 'Selected') {
													if (_v0.b.a.b.a.b.$ === 'View') {
														var rank = _v0.a.a;
														var _v11 = _v0.b.a;
														var u = _v11.a;
														var _v12 = _v11.b.a;
														var l = _v12.a;
														var _v13 = _v12.b;
														return (rank.challenger.id === '6353e8b6aedf80653eb34191') ? _Utils_Tuple2(
															$author$project$Main$AppOps(
																A2(
																	$author$project$Main$Fetched,
																	u,
																	$author$project$Main$Selected(
																		A2(
																			$author$project$Data$Ranking$Ladder,
																			l,
																			$author$project$Data$Ranking$CreateChallenge(rank))))),
																...
																A2(
																	...
																	$author$project$Main$Selected(
																		A2(
																			$author$project$Data$Ranking$Ladder,
																			l,
																			$author$project$Data$Ranking$CreateResult(rank))))),
															$elm$core$Platform$Cmd$none);
													} else {
														if ((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'Create')) {
															break _v0$20;
								...
								case 'ConfirmChallenge':
									if (_v0.b.$ === 'AppOps') {
										switch (_v0.b.a.$) {
											...
											case 'Fetched':
												if (_v0.b.a.b.$ === 'Selected') {
													if (_v0.b.a.b.a.b.$ === 'CreateChallenge') {
														var _v14 = _v0.b.a;
														var u = _v14.a;
														var _v15 = _v14.b.a;
														var l = _v15.a;
																...
																A2(
																	...
																	$author$project$Main$Selected(
																		A2(
																			$author$project$Data$Ranking$Ladder,
																			l,
																			$author$project$Data$Ranking$ConfirmResult(
																				$author$project$Data$Ranking$Won($author$project$Data$Ranking$emptyRank)))))),
															$elm$core$Platform$Cmd$none);
													} else {
														if ((_v0.b.a.a.$ === 'Registered') && (_v0.b.a.a.a.b.$ === 'Create')) {
															break _v0$20;
								...
								case 'TimeUpdated':
									var posixTime = _v0.a.a;
									var _v23 = A2($elm$core$Debug$log, 'posixtime', posixTime);
									return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
								case 'Send':
									var _v24 = _v0.a;
									var modelReDef = _v0.b;
									if (modelReDef.$ === 'AppOps') {
										return _Utils_Tuple2(modelReDef, $elm$core$Platform$Cmd$none);
									} else {
										return _Utils_Tuple2(modelReDef, $elm$core$Platform$Cmd$none);
									}
								case 'Recv':
									var rawJsonMessage = _v0.a.a;
									var _v26 = A2(
										$elm$core$Debug$log,
										'rawJsonMessage',
										A2($elm$json$Json$Encode$encode, 2, rawJsonMessage));
									...
									while (true) {
										if (model.$ === 'AppOps') {
											switch (model.a.$) {
												case 'Login':
													return _Utils_Tuple2(
														$author$project$Main$handleDecodeUser(rawJsonMessage),
														$elm$core$Platform$Cmd$none);
												case 'Loading':
													if (model.a.a.$ === 'Global') {
														if ((model.a.a.a.a.$ === 'Both') && (model.a.a.a.b.$ === 'View')) {
															var _v28 = model.a.a.a;
															var _v29 = _v28.a;
															var _v30 = _v28.b;
															return _Utils_Tuple2(
																$author$project$Main$Failure('This is the model pattern the debugger says we\'re on when click create new ranking'),
																$elm$core$Platform$Cmd$none);
														} else {
															return _Utils_Tuple2(
																$author$project$Main$handleDecodeUser(rawJsonMessage),
																...
																A2(
																	...
																	$author$project$Main$Selected(
																		A2(
																			$author$project$Data$Ranking$Ladder,
																			$author$project$Data$Ranking$Owned(
																				$author$project$Main$handleDecodeRanking(rawJsonMessage)),
																			$author$project$Data$Ranking$View)))),
															$elm$core$Platform$Cmd$none);
													} else {
														if (model.a.a.$ === 'Registered') {
															var _v32 = model.a;
															return _Utils_Tuple2(
																$author$project$Main$Failure('This is the model pattern the debugger says we\'re on when click selected ranking'),
																$elm$core$Platform$Cmd$none);
														} else {
															break _v27$6;
														}
											...
											return _Utils_Tuple2(
												$author$project$Main$Failure('in Recv'),
												$elm$core$Platform$Cmd$none);
										}
									}
									return _Utils_Tuple2(
										$author$project$Main$Failure('fell thru in Recv'),
										$elm$core$Platform$Cmd$none);
								default:
									if (_v0.b.$ === 'AppOps') {
										switch (_v0.b.a.$) {
						...
						return _Utils_Tuple2(
							$author$project$Main$Failure('fell through main update, use Elm debugger to find/create the state pattern'),
							$elm$core$Platform$Cmd$none);
					}
					var _v42 = _v0.b.a;
					var _v43 = _v42.b.a;
					var _v44 = _v43.b;
					return A2($author$project$Main$handleRankingUpdate, msg, model);
				}
				var _v38 = _v0.b.a;
				var _v39 = _v38.b.a;
				var _v40 = _v39.a;
			...
			var _v36 = _v35.a.a;
			var _v37 = _v36.b;
			return A2($author$project$Main$handleUserUpdate, msg, model);
		}
		var _v33 = _v0.b.a.a.a;
		var _v34 = _v33.b;
		return A2($author$project$Main$handleUserUpdate, msg, model);
	});
var $author$project$Main$updateWithStorage = F2(
	function (msg, oldModel) {
		if (oldModel.$ === 'AppOps') {
			var _v1 = A2($author$project$Main$update, msg, oldModel);
			var newModel = _v1.a;
			var cmds = _v1.b;
			return _Utils_Tuple2(
				newModel,
			...
			return _Utils_Tuple2(
				$author$project$Main$Failure('updateWithStorage'),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$confirmResultHeaderView = function (result) {
	switch (result.$) {
		case 'Won':
			var rank = result.a;
			return rank.player.nickname + (' you WON a challenge match vs ' + rank.challenger.nickname);
		case 'Lost':
			var rank = result.a;
			return rank.player.nickname + (' you LOST a challenge match vs ' + rank.challenger.nickname);
		default:
			var rank = result.a;
			return rank.player.nickname + (' you want to ABANDON a challenge match vs ' + rank.challenger.nickname);
	}
};
...
var $author$project$SR$Elements$footer = A2(
	$mdgriffith$elm_ui$Element$paragraph,
	_List_Nil,
	$elm$core$List$singleton(
		$mdgriffith$elm_ui$Element$text('SportRank - all rights reserved. \nUse of this application is without \nany liablity whatsoever.')));
...
var $author$project$Main$confirmResultView = function (result) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
							...
							_List_fromArray(
								[
									...
									_Utils_ap($Orasund$elm_ui_framework$Framework$Button$simple, $Orasund$elm_ui_framework$Framework$Color$simple),
									{
										...
										onPress: $elm$core$Maybe$Just($author$project$Main$Cancel)
									})
								]))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text(
								$author$project$Main$confirmResultHeaderView(result)))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$Orasund$elm_ui_framework$Framework$Heading$h6,
					$mdgriffith$elm_ui$Element$text('Please confirm your result: ')),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
					_List_fromArray(
					...
					$author$project$SR$Elements$footer
				])));
};
var $author$project$Main$ConfirmChallenge = function (a) {
	return {$: 'ConfirmChallenge', a: a};
};
var $author$project$Main$createChallengeView = function (r) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text(r.player.nickname + (' you are challenging ' + r.challenger.nickname)))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
								...
								[
									...
									_Utils_ap($Orasund$elm_ui_framework$Framework$Button$simple, $Orasund$elm_ui_framework$Framework$Color$info),
									{
										...
										onPress: $elm$core$Maybe$Just(
											$author$project$Main$ConfirmChallenge(r))
									})
								]))
						]))
				])));
};
var $author$project$Main$CityAddressChg = function (a) {
	return {$: 'CityAddressChg', a: a};
};
var $author$project$Main$RankingNameChg = function (a) {
	return {$: 'RankingNameChg', a: a};
};
var $author$project$Main$StreetAddressChg = function (a) {
...
var $author$project$Main$enableButton = function (enable) {
...
var $author$project$Main$isValidatedForAllLadderDetailsInput = function (ranking) {
	return $author$project$Utils$Validation$Validate$isValid4to20Chars(ranking.name) && (((ranking.baseaddress.street === '') || $author$project$Utils$Validation$Validate$isValid4to8Chars(ranking.baseaddress.street)) && ((ranking.baseaddress.city === '') || $author$project$Utils$Validation$Validate$isValid4to8Chars(ranking.baseaddress.city)));
};
...
var $author$project$Main$rankingDetailsConfirmPanel = function (ranking) {
	return $author$project$Main$isValidatedForAllLadderDetailsInput(ranking) ? A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$section,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									$Orasund$elm_ui_framework$Framework$Button$simple,
									$author$project$Main$enableButton(
										$author$project$Main$isValidatedForAllLadderDetailsInput(ranking))),
								{
									label: $mdgriffith$elm_ui$Element$text('Confirm'),
									onPress: $elm$core$Maybe$Just($author$project$Main$Confirm)
								})
...
var $author$project$Main$createLadderView = F2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Please Enter Your Ladder \nDetails And Click \'Create\' below:')),
							A2(
							$mdgriffith$elm_ui$Element$wrappedRow,
									...
									_List_fromArray(
										[
													...
													])),
											{
												...
												onChange: $author$project$Main$RankingNameChg,
													...
													])),
											{
												...
												onChange: $author$project$Main$StreetAddressChg,
												placeholder: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
													...
													])),
											{
												...
												onChange: $author$project$Main$CityAddressChg,
												placeholder: $elm$core$Maybe$Just(
													A2(
														$mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
							...
							$author$project$Main$rankingDetailsConfirmPanel(ranking)
						])));
		} else {
			return $elm$html$Html$text('Only a U.Registered (U.AppUser userInfo U.Create) works here');
		}
	});
var $author$project$Main$CreateResult = function (a) {
	return {$: 'CreateResult', a: a};
};
var $author$project$Data$Ranking$Lost = function (a) {
	return {$: 'Lost', a: a};
};
var $author$project$Data$Ranking$Undecided = function (a) {
	return {$: 'Undecided', a: a};
};
var $author$project$Main$createResultBtns = function (rank) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$primary)),
			{
				label: $mdgriffith$elm_ui$Element$text('WON'),
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$CreateResult(
						$author$project$Data$Ranking$Won(rank)))
			}),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$primary)),
			{
				label: $mdgriffith$elm_ui$Element$text('LOST'),
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$CreateResult(
						$author$project$Data$Ranking$Lost(rank)))
			}),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$primary)),
			{
				label: $mdgriffith$elm_ui$Element$text('ABANDON'),
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$CreateResult(
						$author$project$Data$Ranking$Undecided(rank)))
			})
		]);
};
var $author$project$Main$createResultView = function (rank) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text(rank.player.nickname + (' you had a challenge match vs ' + rank.challenger.nickname)))
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$column,
							$Orasund$elm_ui_framework$Framework$Grid$simple,
							$author$project$Main$createResultBtns(rank))
						])),
					$author$project$SR$Elements$footer
				])));
};
var $author$project$Main$errorView = function (errMsg) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$Orasund$elm_ui_framework$Framework$Heading$h6,
					$mdgriffith$elm_ui$Element$text('Apologies, there was an error : ' + errMsg)),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
					_List_fromArray(
...
var $author$project$Main$ClickedLogInUser = {$: 'ClickedLogInUser'};
var $author$project$Main$Create = {$: 'Create'};
var $author$project$Main$infoBtn = F2(
	function (label, msg) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
...
var $author$project$Main$joinBtn = function (user) {
	if (user.$ === 'Spectator') {
		var _v1 = user.a;
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id('existingUserJoinbtn')),
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$simple, $Orasund$elm_ui_framework$Framework$Color$disabled)),
			{
				label: $mdgriffith$elm_ui$Element$text('Join'),
				onPress: $elm$core$Maybe$Just($author$project$Main$Create)
			});
	} else {
		var _v2 = user.a;
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id('newUserJoinbtn')),
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$simple, $Orasund$elm_ui_framework$Framework$Color$disabled)),
			{
				label: $mdgriffith$elm_ui$Element$text('Join'),
...
var $author$project$Main$ViewMember = function (a) {
	return {$: 'ViewMember', a: a};
};
var $author$project$Main$memberRankingBtn = function (ranking) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$simple,
		_List_fromArray(
			[
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$info),
				{
					...
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ViewMember(ranking))
				})
			]));
};
var $author$project$Main$ViewOwned = function (a) {
	return {$: 'ViewOwned', a: a};
};
var $author$project$Main$ownedRankingBtn = function (ranking) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$simple,
		_List_fromArray(
			[
				...
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$primary),
				{
					label: $mdgriffith$elm_ui$Element$text(ranking.name),
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ViewOwned(ranking))
				})
			]));
};
var $author$project$Main$rankingbtns = F2(
	function (dKind, user) {
		if (dKind.$ === 'Global') {
			if (user.$ === 'Spectator') {
				var _v2 = user.a;
				return A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$infoBtn, 'Cancel', $author$project$Main$Cancel),
							$mdgriffith$elm_ui$Element$text('\n'),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Main$infoBtn, 'Create New Ladder', $author$project$Main$Create)
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
							A2($elm$core$List$map, $author$project$Main$ownedRankingBtn, userInfo.ownedRankings)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							$Orasund$elm_ui_framework$Framework$Heading$h5,
							...
							_List_fromArray(
								[
									$author$project$Main$joinBtn(user)
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
							A2($elm$core$List$map, $author$project$Main$memberRankingBtn, userInfo.memberRankings)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							$Orasund$elm_ui_framework$Framework$Heading$h5,
							$mdgriffith$elm_ui$Element$text('Search Other Rankings: '))
						]));
			}
		} else {
			return $mdgriffith$elm_ui$Element$text(' should be global, I think');
		}
	});
...
var $author$project$SR$Elements$warningText = function (warningTxt) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$text(warningTxt));
};
var $author$project$Main$displayGlobalRankingBtns = F3(
	function (userVal, dKind, errorMsg) {
		if (dKind.$ === 'Global') {
			if (userVal.$ === 'Spectator') {
				...
				return A2(
					...
					_List_fromArray(
						[
							A2($author$project$Main$infoBtn, 'Log In', $author$project$Main$ClickedLogInUser),
							$author$project$SR$Elements$warningText(errorMsg),
							A2($author$project$Main$infoBtn, 'Register', $author$project$Main$Create),
							A2(
							$author$project$Main$rankingbtns,
							$author$project$Main$Global(
								A2($author$project$Data$Ranking$Ladder, $author$project$Data$Ranking$Both, $author$project$Data$Ranking$View)),
							userVal)
						]));
			...
			return $mdgriffith$elm_ui$Element$text(' Should be in Global here');
		}
	});
...
var $author$project$Main$globalView = F3(
	function (userVal, dKind, errorMsg) {
		if (userVal.$ === 'Spectator') {
			return A2(
				$Orasund$elm_ui_framework$Framework$responsiveLayout,
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$SR$Elements$globalHeading(userVal),
							$mdgriffith$elm_ui$Element$text('\n'),
							A2($author$project$Main$infoBtn, 'Log Out', $author$project$Main$LogOut),
							A3($author$project$Main$displayGlobalRankingBtns, userVal, dKind, errorMsg)
						])));
		}
	});
var $author$project$Main$UserLoginEmailInputChg = function (a) {
	return {$: 'UserLoginEmailInputChg', a: a};
};
var $author$project$Main$UserLoginPasswordInputChg = function (a) {
	return {$: 'UserLoginPasswordInputChg', a: a};
};
var $elm$html$Html$Attributes$autofocus = $elm$html$Html$Attributes$boolProperty('autofocus');
var $mdgriffith$elm_ui$Element$Input$focusedOnLoad = $mdgriffith$elm_ui$Internal$Model$Attr(
	$elm$html$Html$Attributes$autofocus(true));
var $author$project$Main$displayLoginBtns = function (emailpasswod) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$section,
		_List_fromArray(
							...
							[
										...
										])),
								{
									label: A2(
										...
										$mdgriffith$elm_ui$Element$text('Email')),
									onChange: $author$project$Main$UserLoginEmailInputChg,
									placeholder: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
											$mdgriffith$elm_ui$Element$text('Email'))),
									text: emailpasswod.email
								}),
								A2(
								$mdgriffith$elm_ui$Element$Input$text,
								_Utils_ap(
										...
										])),
								{
									...
									onChange: $author$project$Main$UserLoginPasswordInputChg,
									placeholder: $elm$core$Maybe$Just(
										A2(
											$mdgriffith$elm_ui$Element$Input$placeholder,
											_List_Nil,
											$mdgriffith$elm_ui$Element$text('Password'))),
									text: emailpasswod.password
								})
							]))
					])),
				A2($author$project$Main$infoBtn, 'Log In', $author$project$Main$ClickedLogInUser),
				A2($author$project$Main$infoBtn, 'Register', $author$project$Main$Create),
				A2($author$project$Main$infoBtn, 'Search Rankings', $author$project$Main$Create)
			]));
};
var $author$project$Main$loginView = function (emailpassword) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('\n'),
					$author$project$Main$displayLoginBtns(emailpassword)
				])));
};
var $author$project$Main$Delete = {$: 'Delete'};
var $author$project$SR$Elements$memberSelectedRankingHeaderEl = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		$Orasund$elm_ui_framework$Framework$Heading$h5,
		$mdgriffith$elm_ui$Element$text('SportRank - Member Ranking' + (' - ' + r.name)));
};
var $author$project$Main$ViewRank = function (a) {
	return {$: 'ViewRank', a: a};
};
var $author$project$Main$configureThenAddPlayerRankingBtns = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$simple,
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_Utils_ap($Orasund$elm_ui_framework$Framework$Button$fill, $Orasund$elm_ui_framework$Framework$Color$light),
				{
					label: $mdgriffith$elm_ui$Element$text(
						$elm$core$String$fromInt(r.rank) + ('. ' + (r.player.nickname + (' vs ' + r.challenger.nickname)))),
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ViewRank(r))
				})
			]));
};
var $author$project$Main$playerbuttons = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		$Orasund$elm_ui_framework$Framework$Grid$section,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$column,
				_Utils_ap($Orasund$elm_ui_framework$Framework$Card$simple, $Orasund$elm_ui_framework$Framework$Grid$simple),
				A2($elm$core$List$map, $author$project$Main$configureThenAddPlayerRankingBtns, r.ranking))
			]));
};
var $author$project$Main$memberSelectedView = function (r) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$SR$Elements$memberSelectedRankingHeaderEl(r)
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					A2(
					...
					_List_fromArray(
						[
							A2($author$project$Main$infoBtn, 'Leave', $author$project$Main$Delete),
							A2($author$project$Main$infoBtn, 'Cancel', $author$project$Main$Cancel),
							$author$project$Main$playerbuttons(r)
						]))
				])));
};
var $author$project$SR$Elements$ownedSelectedRankingHeaderEl = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		$Orasund$elm_ui_framework$Framework$Heading$h5,
		$mdgriffith$elm_ui$Element$text('SportRank - Owned Ranking' + (' - ' + (r.name + (' - ' + r.owner_name)))));
};
var $author$project$Main$ownedSelectedView = function (r) {
	return A2(
		$Orasund$elm_ui_framework$Framework$responsiveLayout,
		_List_Nil,
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$infoBtn, 'Delete', $author$project$Main$Delete),
							A2($author$project$Main$infoBtn, 'Cancel', $author$project$Main$Cancel),
							$author$project$Main$playerbuttons(r)
						]))
				])));
};
var $author$project$Main$DescCommentChg = function (a) {
	return {$: 'DescCommentChg', a: a};
};
var $author$project$Main$DescLevelChg = function (a) {
	return {$: 'DescLevelChg', a: a};
};
var $author$project$Main$EmailChg = function (a) {
	return {$: 'EmailChg', a: a};
};
var $author$project$Main$MobileChg = function (a) {
	return {$: 'MobileChg', a: a};
};
var $author$project$Main$NickNameChg = function (a) {
	return {$: 'NickNameChg', a: a};
};
var $author$project$Main$PwdChg = function (a) {
	return {$: 'PwdChg', a: a};
};
...
var $author$project$Main$emailValidationErr = function (str) {
...
var $author$project$Main$mobileValidationErr = function (str) {
...
var $author$project$Data$User$isNickNameEmpty = function (u) {
	return ($author$project$Data$User$gotNickName(u) === '') ? true : false;
};
var $author$project$Utils$Validation$Validate$is20CharMax = function (str) {
	return ($elm$core$String$length(str) <= 20) ? true : false;
};
var $author$project$Main$isValidatedForAllUserDetailsInput = function (user) {
	if (user.$ === 'Spectator') {
		var _v1 = user.a;
		var userInfo = _v1.a;
		return $author$project$Utils$Validation$Validate$isEmailValid(userInfo.email) ? true : false;
	} else {
		var _v2 = user.a;
		var userInfo = _v2.a;
		return ($author$project$Utils$Validation$Validate$is20CharMax('') && ($author$project$Utils$Validation$Validate$isEmailValid(userInfo.email) && $author$project$Utils$Validation$Validate$isMobileValid(userInfo.mobile))) ? true : false;
	}
};
var $author$project$Main$userDetailsConfirmPanel = function (user) {
	if (user.$ === 'Spectator') {
		var _v1 = user.a;
		var userInfo = _v1.a;
		return (($author$project$Utils$Validation$Validate$isEmailValid(userInfo.email) && ($elm$core$String$length(userInfo.email) > 0)) && (($author$project$Utils$Validation$Validate$isValid4to8Chars(userInfo.password) && ($elm$core$String$length(userInfo.password) > 0)) && ($author$project$Data$User$isNickNameEmpty(user) || $author$project$Utils$Validation$Validate$isValid4to8Chars(
			$author$project$Data$User$gotNickName(user))))) ? A2(
			$mdgriffith$elm_ui$Element$column,
			$Orasund$elm_ui_framework$Framework$Grid$section,
			_List_fromArray(
				[
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										$Orasund$elm_ui_framework$Framework$Button$simple,
										$author$project$Main$enableButton(
											$author$project$Main$isValidatedForAllUserDetailsInput(user))),
									{
		...
		return (($author$project$Utils$Validation$Validate$isEmailValid(userInfo.email) && ($elm$core$String$length(userInfo.email) > 0)) && (($author$project$Utils$Validation$Validate$isValid4to8Chars(userInfo.password) && ($elm$core$String$length(userInfo.password) > 0)) && ($author$project$Data$User$isNickNameEmpty(user) || $author$project$Utils$Validation$Validate$isValid4to8Chars(
			...
			_List_fromArray(
				[
					$author$project$SR$Elements$warningParagraph,
					A2(
					$mdgriffith$elm_ui$Element$el,
					$Orasund$elm_ui_framework$Framework$Heading$h6,
					$mdgriffith$elm_ui$Element$text('Click to continue ...')),
...
var $author$project$Main$registerView = function (userVal) {
	if (userVal.$ === 'Spectator') {
		var _v1 = userVal.a;
		var userInfo = _v1.a;
		return A2(
									...
									[
												...
												])),
										{
											label: A2(
												...
												$mdgriffith$elm_ui$Element$text('Email*')),
											onChange: $author$project$Main$EmailChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
										...
										$author$project$Main$emailValidationErr(userInfo.email),
										A2(
										$mdgriffith$elm_ui$Element$Input$text,
										_Utils_ap(
											$Orasund$elm_ui_framework$Framework$Input$simple,
												...
												])),
										{
											label: A2(
												...
												$mdgriffith$elm_ui$Element$text('Password*')),
											onChange: $author$project$Main$PwdChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
												...
												])),
										{
											...
											onChange: $author$project$Main$NickNameChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
												...
												])),
										{
											...
											onChange: $author$project$Main$DescLevelChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
												...
												])),
										{
											...
											onChange: $author$project$Main$DescCommentChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
												...
												])),
										{
											label: A2(
												...
												$mdgriffith$elm_ui$Element$text('Mobile \n(inc. Int code\neg.+65)')),
											onChange: $author$project$Main$MobileChg,
											placeholder: $elm$core$Maybe$Just(
												A2(
													$mdgriffith$elm_ui$Element$Input$placeholder,
													_List_Nil,
													$mdgriffith$elm_ui$Element$text('Mobile'))),
											text: A2($author$project$Utils$Validation$Validate$validatedMaxTextLength, userInfo.mobile, 25)
										}),
										$author$project$Main$mobileValidationErr(userInfo.mobile)
									]))
							])),
						$mdgriffith$elm_ui$Element$text('* required'),
						$author$project$SR$Elements$justParasimpleUserInfoText,
						$author$project$Main$userDetailsConfirmPanel(userVal),
						$mdgriffith$elm_ui$Element$text('\n')
					])));
	} else {
		var _v2 = userVal.a;
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_framework$Framework$Heading$h5,
						$mdgriffith$elm_ui$Element$text('You are already registered!! :) ')),
						$author$project$SR$Elements$justParasimpleUserInfoText
					])));
	}
};
var $author$project$Main$view = function (model) {
	...
	while (true) {
		if (model.$ === 'AppOps') {
			switch (model.a.$) {
				case 'Loading':
					return $elm$html$Html$text('Loading ... here');
				case 'Login':
					var emailpword = model.a.a;
					return $author$project$Main$loginView(emailpword);
				case 'RegisSpectator':
					var user = model.a.a;
					return $author$project$Main$registerView(user);
				default:
					if (model.a.b.$ === 'Global') {
						switch (model.a.b.a.b.$) {
							case 'View':
								var _v1 = model.a;
								var user = _v1.a;
								var _v2 = _v1.b.a;
								var _v3 = _v2.b;
								return A3(
									$author$project$Main$globalView,
									user,
									$author$project$Main$Global(
										A2($author$project$Data$Ranking$Ladder, $author$project$Data$Ranking$Both, $author$project$Data$Ranking$View)),
									'');
							case 'Create':
								switch (model.a.b.a.a.$) {
									case 'Both':
										var _v4 = model.a;
										var user = _v4.a;
										var _v5 = _v4.b.a;
										var _v6 = _v5.a;
										var _v7 = _v5.b;
										return A2($author$project$Main$createLadderView, user, $author$project$Data$Ranking$emptyRanking);
									case 'Owned':
										var _v8 = model.a;
										var user = _v8.a;
										var _v9 = _v8.b.a;
										var r = _v9.a.a;
										var _v10 = _v9.b;
										return A2($author$project$Main$createLadderView, user, r);
									default:
										break _v0$12;
								}
							default:
							...
							case 'View':
								switch (model.a.b.a.a.$) {
									case 'Owned':
										...
										var r = _v12.a.a;
										var _v13 = _v12.b;
										return $author$project$Main$ownedSelectedView(r);
									case 'Member':
										var _v14 = model.a;
										var _v15 = _v14.b.a;
										var r = _v15.a.a;
										var _v16 = _v15.b;
										return $author$project$Main$memberSelectedView(r);
									default:
										break _v0$12;
								}
							case 'CreateChallenge':
								if (model.a.a.$ === 'Registered') {
									...
									var _v18 = _v17.b.a;
									var rank = _v18.b.a;
									return $author$project$Main$createChallengeView(rank);
								} else {
									break _v0$12;
								}
							case 'CreateResult':
								if (model.a.a.$ === 'Registered') {
									...
									var _v20 = _v19.b.a;
									var rank = _v20.b.a;
									return $author$project$Main$createResultView(rank);
								} else {
									break _v0$12;
								}
							case 'ConfirmResult':
								var _v21 = model.a;
								var _v22 = _v21.b.a;
								return $author$project$Main$confirmResultView(
									$author$project$Data$Ranking$Won($author$project$Data$Ranking$emptyRank));
							default:
								break _v0$12;
						}
			...
			var errMsg = model.a;
			return $author$project$Main$errorView(errMsg);
		}
	}
	return $elm$html$Html$text('view fell through ');
};
var $author$project$Main$main = A4(
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"TimeTravel.Browser.Msg Main.Msg","aliases":{"Data.Ranking.BaseAddress":{"args":[],"type":"{ street : String.String, city : String.String }"},"Data.User.MemberRanking":{"args":[],"type":"{ id : String.String, name : String.String }"},"Data.User.OwnedRanking":{"args":[],"type":"{ id : String.String, name : String.String }"},"Data.Ranking.Player":{"args":[],"type":"{ id : String.String, nickname : String.String }"},"Data.Ranking.Rank":{"args":[],"type":"{ rank : Basics.Int, player : Data.Ranking.Player, challenger : Data.Ranking.Player }"},"Data.Ranking.Ranking":{"args":[],"type":"{ id : String.String, active : Basics.Bool, name : String.String, owner_id : String.String, baseaddress : Data.Ranking.BaseAddress, ranking : List.List Data.Ranking.Rank, player_count : Basics.Int, owner_name : String.String }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"TimeTravel.Internal.Parser.AST.ASTId":{"args":[],"type":"String.String"},"TimeTravel.Internal.Model.Id":{"args":[],"type":"Basics.Int"},"TimeTravel.Internal.Model.IncomingMsg":{"args":[],"type":"{ type_ : String.String, settings : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"View":[],"Confirm":[],"Create":[],"Cancel":[],"Delete":[],"ViewOwned":["Data.User.OwnedRanking"],"ViewMember":["Data.User.MemberRanking"],"ClickedLogInUser":[],"LogOut":[],"UserLoginEmailInputChg":["String.String"],"UserLoginPasswordInputChg":["String.String"],"EmailChg":["String.String"],"PwdChg":["String.String"],"NickNameChg":["String.String"],"MobileChg":["String.String"],"DescLevelChg":["String.String"],"DescCommentChg":["String.String"],"ViewRank":["Data.Ranking.Rank"],"ViewChallengeOpponent":["Data.Ranking.Rank"],"ConfirmNewRanking":["Data.Ranking.Ranking"],"ConfirmChallenge":["Data.Ranking.Rank"],"RankingNameChg":["String.String"],"StreetAddressChg":["String.String"],"CityAddressChg":["String.String"],"CreateResult":["Data.Ranking.ResultOfMatch"],"LadderNameInputChg":["String.String"],"LadderDescInputChg":["String.String"],"Send":[],"Recv":["Json.Decode.Value"],"TimeUpdated":["Time.Posix"]}},"TimeTravel.Browser.Msg":{"args":["msg"],"tags":{"DebuggerMsg":["TimeTravel.Internal.Model.Msg"],"UserMsg":["( Maybe.Maybe Basics.Int, msg )"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"TimeTravel.Internal.Model.Msg":{"args":[],"tags":{"ToggleSync":[],"ToggleExpand":[],"ToggleFilter":["String.String"],"SelectMsg":["TimeTravel.Internal.Model.Id"],"Resync":[],"ToggleLayout":[],"Receive":["TimeTravel.Internal.Model.IncomingMsg"],"ToggleModelDetail":["Basics.Bool"],"ToggleModelTree":["TimeTravel.Internal.Parser.AST.ASTId"],"ToggleMinimize":[],"InputModelFilter":["String.String"],"SelectModelFilter":["TimeTravel.Internal.Parser.AST.ASTId"],"SelectModelFilterWatch":["TimeTravel.Internal.Parser.AST.ASTId"],"StopWatching":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Data.Ranking.ResultOfMatch":{"args":[],"tags":{"Won":["Data.Ranking.Rank"],"Lost":["Data.Ranking.Rank"],"Undecided":["Data.Ranking.Rank"]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));